...
const PLANS: Plan[] = [
  {
    key: 'tournament',
    name: 'Tournament',
    tagline: 'Run one tournament with manual scheduling, team communication, scores, and public results - free forever.',
    monthlyPrice: 'Free',
    annualPrice: null,
    annualTotal: null,
    annualSavings: null,
  ...
  },
  {
    ...
    tagline: 'Add tournament automation, permanent history, premium branding, and more capacity.',
    monthlyPrice: '$39',
    annualPrice: '$390',
