  ...
  return (
    <div className={styles.catalog}>
      <p className={styles.intro}>
        ...
        team — and ignore what isn&apos;t. It&apos;s all free.
      </p>
      ...
      <Link
        ...
        className={styles.premiumNudge}
        target="_blank"
        rel="noopener noreferrer"
      >
        <span>
          <strong>Running a full season or club?</strong> FieldLogicHQ does rosters, scheduling,
          and accounting for whole organizations.
