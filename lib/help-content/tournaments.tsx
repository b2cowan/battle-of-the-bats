...

    {
      ...
      content: (
        <>
          ...
          <p><strong>Telling a parent who&rsquo;s on a computer.</strong> A phone is what installs the app, so on a laptop the app screens now show a <strong>QR code</strong> &mdash; in the page footer, and as a <strong>Get the app</strong> card under <strong>Account</strong>. A parent points their phone camera at it and lands in the app on the phone, ready to add to the home screen. On a phone those screens show the direct <strong>Install app</strong> action instead, so nobody is ever told to scan a code with the device they&rsquo;re already holding.</p>
