        ...
        },
        {
          ...
          answer: (
            <>
              ...
              <p>This is separate from the <strong>Scores</strong> tab, a platform-wide live board of every tournament underway right now — not just the fan&rsquo;s own teams. Home is personal; Scores is discovery.</p>
            </>
          ),
        },
        {
