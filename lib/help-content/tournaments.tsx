        ...
        },
        {
          ...
          answer: (
            <>
              ...
              <p>Listing also makes your event and its <strong>accepted teams</strong> findable in the app&rsquo;s <strong>Home search</strong>: a fan can search a team by name and land on that team&rsquo;s page inside your event (team name and event only — never rosters or contacts). Unlisted and private events never appear in search.</p>
              <p>Your listing only appears once the tournament is <strong>Active</strong> or <strong>Completed</strong> — a draft stays hidden even with the toggle on. Turn the toggle off any time to remove the tournament — and its teams — from the directory and search.</p>
            </>
          ),
        },
        {
...

    {
      ...
      content: (
        <>
          ...
          <p><strong>A door to the wider app.</strong> The app&rsquo;s own bar &mdash; <strong>Home</strong>, <strong>Scores</strong>, <strong>Chat</strong>, <strong>Account</strong> &mdash; now stays on screen the whole time a fan is inside your event (a slim bar along the bottom on phones, a thin strip across the top on a computer), so a fan who arrived by QR code or a shared link can step out to the app-wide directory (<strong>Home</strong>) or the live board (<strong>Scores</strong>) at any time, signed in or not &mdash; no menu to hunt for. It carries your event&rsquo;s colours so it reads as quiet app chrome, never a competing brand. Your tournament&rsquo;s own pages sit in a row of tabs just under the branded header &mdash; <strong>Overview</strong>, News, Schedule, Standings, Teams, Rules (only the pages you publish). A <strong>coach, admin, or scorekeeper</strong> signed in and viewing the public site sees a small chip in the header that jumps straight back to their own tools for this event; fans don&rsquo;t see it &mdash; the bottom bar and the follow strip already cover signing in, following, and getting around.</p>
          <p><strong>Search on Home.</strong> The app&rsquo;s <strong>Home</strong> leads with a search that finds a <strong>Tournament</strong>, a <strong>Team</strong>, or an <strong>Organization</strong> by name, with a chip to narrow to one kind. A tournament match opens that event; an organization match opens its public page; a <strong>team</strong> match drops the fan straight onto that team&rsquo;s page inside its event. Team matches come only from tournaments listed in the public directory — a private event&rsquo;s teams never appear, and only the team name and its event are shown, never rosters or contacts.</p>
        </>
      ),
      faqs: [
        {
