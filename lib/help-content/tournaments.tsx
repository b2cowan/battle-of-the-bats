...

    {
      ...
      content: (
        <>
          ...
          <p><strong>A door to the wider app.</strong> The event&rsquo;s <strong>More</strong> menu ends with two FieldLogicHQ rows — <strong>Browse tournaments</strong> and <strong>Live scores</strong> — so a fan who arrived by QR code or a shared link can step out of your event into the app-wide directory and live board at any time, signed in or not.</p>
      ...
      faqs: [
        ...
        },
        {
          ...
          answer: (
            <>
              <p>Yes — and neither needs an account. A <strong>&ldquo;Follow this tournament&rdquo;</strong> strip sits just under the event header on a tournament&rsquo;s home page (and as a row in its <strong>More</strong> sheet); one tap follows the <strong>whole event</strong>, so it shows up on the fan&rsquo;s <strong>Home</strong> with a live status line (like &ldquo;3 live now&rdquo; or &ldquo;Starts Saturday&rdquo;) and as a tile on their <strong>Scores</strong> tab until it wraps up.</p>
