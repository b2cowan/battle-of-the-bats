    ...
    },
    {
      ...
      subtopics: [
        ...
        },
        {
          ...
          content: (
            <>
              <p>The <strong>Tags</strong> group is the shelf for every tag library your team keeps — money tags, game tags, focus tags, staff and equipment — one row each, with a count of your own words and any <strong>shared by your club</strong>. Open a row to <strong>rename</strong>, <strong>merge</strong> or <strong>delete</strong> a tag: every tag shows how many records it&rsquo;s on, renaming reaches everything already recorded, merging folds two words into one and keeps the history, and deleting tells you what it touches and offers <strong>Merge instead</strong>. Shared tags are listed read-only — ask your club admin to change one.</p>
              <p>You don&rsquo;t have to come here for a quick fix — every tag field across the portal carries its manage door as the last row of its dropdown — <strong>Manage tags…</strong> on a Tags box, <strong>Manage staff…</strong> and <strong>Manage equipment…</strong> on those fields, opening the same manager beside whatever you were doing. This shelf is the season-end tidy; each library holds up to 50 of your own tags, and merging two makes room.</p>
            </>
          ),
        },
        {
