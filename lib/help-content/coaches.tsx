    ...
    },
    {
      ...
      faqs: [
        ...
        },
        {
          ...
          answerText: 'The six Overview tiles are your team at a glance and keep the same places all season. Most coaches see record, roster, next up (or this week when the card above is already about your next game), tournaments, dues and budget. If you do not have money access, the two money tiles are replaced — not removed — by Attendance (your season average and how many players have slipped below 70%) and Playing time (whether minutes are spread fairly across your saved lineups), so assistant coaches get a full board rather than a gap. Before you have set up any money, dues and budget collapse into a single "Money — not set up" tile and the freed space goes to Attendance; set up dues or a budget and the two tiles return. A tile reading "Not set" or "Not enough yet" is not broken — attendance and playing time wait for a few real sessions before showing a number rather than guessing from one.',
          keywords: ['overview tiles', 'six tiles', 'at a glance', 'tiles changed', 'missing tile', 'attendance tile', 'playing time tile', 'playing time fair', 'money not set up', 'dues tile', 'budget tile', 'record tile', 'this week tile', 'next up tile', 'not enough yet', 'not set', 'assistant coach tiles', 'different tiles', 'why is my board different'],
          popular: true,
        },
        {
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <p>Four numbers sit at the top: <strong>Money In</strong> (dues and fundraising actually received), <strong>Money Out</strong> (everything actually paid — expenses, and for club-owned teams, payments to your organization), <strong>On Hand</strong> (received minus paid), and <strong>Budget Headroom</strong> (what&apos;s left of your budget). A line above the row says it plainly: these are <strong>cash received and cash paid, not what&apos;s still owed</strong>. An unpaid bill or an unpaid instalment doesn&apos;t move them until it&apos;s marked paid — which is why they always agree with the Budget vs. Actual report — and a link takes you straight to <strong>what&apos;s outstanding</strong> on Player Dues.</p>
          <p>The sections below the numbers follow the treasurer&apos;s workflow: <strong>Plan</strong> (Season Budget Plan) → <strong>Collect</strong> (Player Dues, Fundraisers) → <strong>Spend</strong> (Expenses &amp; Payables — plus Org Allocations and Payment Requests when a club or league runs your team) → <strong>Review</strong> (Budget vs. Actual). Every card shows live figures, and every page has a <strong>&larr; Back to Money</strong> link. On a club-run team, <strong>Org Allocations</strong> and <strong>Payment Requests</strong> also link to each other — what the club has billed you on one, and how you pay it back or claim a reimbursement on the other.</p>
          ...
          <p><strong>Bringing a budget in from a spreadsheet.</strong> <strong>Import</strong> sits beside <em>Add Line</em> on Season Budget Plan (and <strong>Import payables</strong> on Expenses &amp; Payables). Pick which shape your sheet is — a <strong>month grid</strong> (a row per cost, a column per month), a <strong>simple list</strong> (one amount per line), or a <strong>payables schedule</strong> (what you owe and when) — then either <strong>paste</strong> your rows straight out of Excel or Google Sheets, or <strong>upload</strong> the file. Pasting works on a phone; both end up in the same place.</p>
          ...
          <p>Assistant coaches need <strong>money access</strong> from the head coach: with read access they see every number but <strong>no action buttons anywhere in Money</strong> — nothing they can&apos;t finish is offered to them; with it off, Money doesn&apos;t appear for them at all. Applying or editing a money tag needs <strong>money edit</strong> access, the same as logging an expense.</p>
        </>
      ),
      faqs: [
        {
        ...
        },
        {
          ...
          answer: (
            <p>All four are <strong>cash</strong> — received and paid, never what&apos;s still owed. The line above them says so, and links to what&apos;s outstanding. <strong>Money In</strong> is dues families have actually paid plus fundraising raised (plus anything your org reimbursed, on club-owned teams). <strong>Money Out</strong> is everything actually paid out — expenses, tournament deposits and balances, and payments to your org. <strong>On Hand</strong> is simply received minus paid. <strong>Budget Headroom</strong> compares your paid spending to your budget — green means room left, red means over. Unpaid bills and unpaid dues don&apos;t move these numbers until they&apos;re marked paid, which is why Money and the Budget vs. Actual report always agree. To see what families still owe, open <strong>Player Dues</strong>.</p>
          ),
          answerText: 'All four are cash — received and paid, never what is still owed. The line above them says so and links to what is outstanding. Money In is dues families have actually paid plus fundraising raised (plus anything your org reimbursed, on club-owned teams). Money Out is everything actually paid out — expenses, tournament deposits and balances, and payments to your org. On Hand is received minus paid. Budget Headroom compares your paid spending to your budget — green means room left, red means over. Unpaid bills and unpaid dues do not move these numbers until marked paid, which is why Money and the Budget vs. Actual report always agree. To see what families still owe, open Player Dues.',
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <p><strong>An assistant coach</strong> is staff. They start with the least access that is still useful — seeing and changing the schedule, attendance, lineups, a view of the roster basics, and the blank team forms — and they&rsquo;re in your staff chat. Everything sensitive is off until you switch it on: guardian contacts and dates of birth, private player notes, team money, sending announcements to families, and tryouts.</p>
