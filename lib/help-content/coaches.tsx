        ...
        },
        {
          ...
          content: (
            <>
              ...
              <p><strong>You can change it later, even after the club has answered.</strong> Every row on the Club screen — a bill the club sent you or a request you made — <strong>opens where it sits</strong> when you tap it, and both of these questions are live controls inside it, ready to change on the spot. <strong>Re-filing moves no money</strong>; it moves which row of the report tells the story. Requests that were approved before this question existed keep reading as repayments until you say otherwise — nothing was quietly re-interpreted behind you.</p>
              <p><strong>Every request is reviewed by someone at the club</strong>, and sits as <strong>Awaiting the club</strong> until the office gets to it — pinned to the top of the list, with a marked edge, because it is the only row whose <em>ask</em> you can still change. Until then it&apos;s still yours: open the row and press <strong>Edit or withdraw this request</strong> to correct anything — amount, wording, what it&apos;s for, even which direction it goes — or to take it off their list. Withdrawing asks first, because nothing is kept.</p>
              ...
              <p><strong>Once the club answers, the ask locks — your own filing never does.</strong> An approved or declined row still opens, and shows what was asked, when you raised it, what the club decided and when, and how the money moves — as facts now, because that is what they acted on. A decline shows their written reason at the top. What stays live in there is the part that was always yours: what it files under, and whether money from the club was new money or money back. Every row on the screen carries the same chevron, so nothing has to be pressed to find out whether it will let you in.</p>
