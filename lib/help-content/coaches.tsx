        ...
        },
        {
          ...
          content: (
            <>
              ...
              <p><strong>Every figure on a row opens what&apos;s behind it.</strong> Tap the <strong>budget</strong> figure to see the plan lines summed into that row, with their amounts and notes &mdash; open one to edit it. Tap the <strong>actual</strong> figure to see every payment counted against the row, with any <strong>money back</strong> listed underneath and netted off. Tap the row itself to open its payment schedule.</p>
              ...
              <p><strong>Player dues has no plan lines behind it</strong> &mdash; dues are a schedule, not budget lines &mdash; so its budget figure doesn&rsquo;t open. Its <strong>actual</strong> figure does, whenever part of what families contributed didn&rsquo;t arrive as cash: <strong>What families contributed</strong> splits it into cash families sent and kept, team bills families paid a vendor directly, and fundraising credited against their dues. It offers <strong>Open Player Dues</strong> and <strong>Open the Ledger</strong>. Money you&rsquo;ve handed back to a family is in none of those three &mdash; see the <em>Cash</em> reading for what your account did.</p>
              ...
              <p><strong>Haven&rsquo;t set dues yet?</strong> The row says <em>Not set yet</em> with a dash rather than $0.00 &mdash; because nothing owed and nothing set up are different things &mdash; and offers a link straight to Player Dues. Every team is in that state on day one.</p>
        ...
        },
        {
          ...
          content: (
            <>
              ...
              <p><strong>Manage our words</strong> on the Budget Plan looks after the categories and words your team invented. <strong>Categories</strong> come first: a category you add belongs to your team alone — no other team sees it — and you can rename it here, which changes it everywhere including on everything already filed under it. The <strong>Standard</strong> categories that come with FieldLogicHQ and the <strong>Club</strong> categories your club shares with every team are listed underneath as read-only; only your club can rename one of its own, from its Org Budget screen. Categories can&apos;t be deleted by anyone — removing a heading would strip the filing from everything underneath it, so renaming is the way to fix one. Below the categories sit the words themselves. <strong>Rename</strong> one and it changes everywhere, including on everything already recorded against it. <strong>Remove</strong> works while nothing is filed against it. And <strong>Use a shared word instead</strong> folds one or more of yours into a Standard or Club word on the same side — tick your words, pick the replacement, and it tells you how many records move before you confirm. Your words are removed afterwards and <strong>no money changes</strong>, only what it&apos;s filed under. If the shared word sits under a different category it says so first, because those records move to that heading on the report. A word always stays on its side.</p>
