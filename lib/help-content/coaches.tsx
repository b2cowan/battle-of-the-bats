          ...
          content: (
            <>
              ...
              <HelpDefs>
                ...
                <HelpDef term="We paid a family back">Only families the team is holding money for are offered; lands on that player&apos;s payout record, same as paying out from Player Dues.</HelpDef>
              </HelpDefs>
        ...
        },
        {
          ...
          content: (
            <>
              ...
              <p>A credit is <strong>money somebody other than the family put toward their dues</strong> — a fundraising credit, a sponsor, a contribution, or a cost the family paid out of pocket for the team. It lands on their real installments, so the amount you ask them for actually drops:</p>
              <HelpSteps>
