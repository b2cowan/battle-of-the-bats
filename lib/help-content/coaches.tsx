        ...
        },
        {
          ...
          content: (
            <>
              ...
              <p>Each column is headed by its <strong>due date</strong>, with the installment number and the amount underneath (or &ldquo;Varies&rdquo; where families have different dates for the same installment). The installment you should be chasing — the earliest still owed, with a late one first — is <strong>lit</strong>, and the grid opens with it in view. Each cell answers one question: <em>is there anything still to send here?</em></p>
              <HelpDefs>
              ...
              <p>So every figure left on the grid is money still to come in. A player whose own installment differs from the rest of the team&apos;s shows their own amount and date in the cell. On a phone the grid becomes a card per player instead, which spells each installment out in words.</p>
        ...
        },
        {
          ...
          content: (
            <>
              ...
              <p><strong>Tap any bill to open it</strong> — including one that is fully paid, and from the <strong>Timeline</strong> as well as from here. The bill&apos;s own page shows the whole thing in one place: every scheduled payment with its own state, every payment you have recorded, and the one figure that matters. <strong>Add an installment</strong> puts another dated payment on any bill, however many it already has. Each scheduled payment also has its own <strong>Change</strong> and <strong>Remove</strong> — <a href="#premium-money-repeating">how far those reach</a> is its own answer.</p>
              <p><strong>The page edits itself — there is no Edit button.</strong> The bill&apos;s name, what it is filed under, who it is paid to, its tags, how it is paid and any note are all live where you read them: click one, change it, and it saves on its own a moment after you stop typing. A small <em>Saved</em> at the foot of the page tells you when it has. Nothing there moves money, which is why it can save quietly — the <strong>amount</strong> is not one of those fields, because a commitment&apos;s total is simply the sum of its installments and is changed on the schedule. A field you have not filled in still shows, as an invitation rather than a blank: <em>Add a note</em>. And if you can read the team&apos;s money but not change it, you see the same page with values instead of boxes.</p>
              <p><strong>Deleting a bill</strong> is at the foot of its page, below the schedule. It asks first, and it asks in dollars: if money has already gone out against this bill, deleting it puts that money back on the books, and the question says how much before you answer it.</p>
              ...
              <p><strong>Every payment can be undone.</strong> Open the bill and <strong>Undo</strong> beside a payment puts the books back by exactly that amount — a mis-tap is a two-second fix. Paying <em>more</em> than what&apos;s owed saves too, and the bill says how far over it went; the book should read the way the bank statement does.</p>
        ...
        },
        {
          ...
          content: (
            <>
              ...
              <p><strong>Over budget is good news on income and bad news on a cost</strong>, so the wording changes with the section: revenue reads <em>+$400</em> or <em>−$160</em>; costs read <em>$150 under</em> or <em>$160 over</em> — and a quiet key under the table says so. A figure in <strong>brackets</strong> is a negative — most often a refund filed against the wrong item, which is exactly why it&apos;s shown rather than hidden or flipped; a cost row holding <em>only</em> money back reads <strong>&ldquo;refund only&rdquo;</strong> rather than pretending to be an underspend. A row nobody budgeted carries a quiet <strong>&ldquo;not planned&rdquo;</strong> word beside its name.</p>
