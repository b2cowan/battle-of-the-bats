        ...
        },
        {
          ...
          content: (
            <>
              ...
              <p><strong>Your season&apos;s dues, at the top of the screen.</strong> Player Dues opens with four figures: <strong>Assessed</strong> (and how many players), <strong>Collected</strong> — cash, with any fundraising credits named underneath rather than added in — <strong>Balance owing</strong>, and <strong>Past due</strong> with the number of families behind. <strong>Past due only appears when there is some</strong>; a season where nobody is behind shows three figures instead of a zero under a red word. They sit above the list, so they read the same whichever view you are in and you don&apos;t scroll a roster to reach them. Nothing shows at all until at least one player has a dues schedule.</p>
              ...
              <p><strong>Collected counts what settled a bill</strong>, so it can never run past <strong>Assessed</strong>. Where a family has sent more than they were billed, the extra is named underneath instead — <em>&ldquo;$550.00 more sent than billed&rdquo;</em> — which is why adding up the <strong>Paid</strong> column can come to more than the tile. The column answers <em>what did this family send</em>; the tile answers <em>how much of what we billed is settled</em>.</p>
            </>
          ),
        },
        {
