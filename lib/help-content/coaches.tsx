    ...
    },
    {
      ...
      content: (
        <>
          ...
          <p>The sections below the numbers follow the treasurer&apos;s workflow: <strong>Plan</strong> (Season Budget Plan) → <strong>Collect</strong> (Player Dues, Fundraisers) → <strong>Spend</strong> (Expenses &amp; Payables — plus Org Allocations and Payment Requests when a club or league runs your team) → <strong>Review</strong> (Budget vs. Actual). Every card shows live figures, and tapping one opens it as a <strong>tab</strong> right there on Money — a tab bar sits across the top the whole time, so hopping between screens never means leaving the page and finding your way back. On a club-run team, <strong>Org Allocations</strong> and <strong>Payment Requests</strong> also link to each other — what the club has billed you on one, and how you pay it back or claim a reimbursement on the other.</p>
      ...
      faqs: [
        ...
        },
        {
          ...
          answer: (
            <p>Tap any tab — <strong>Budget Plan</strong>, <strong>Player Dues</strong>, <strong>Fundraisers</strong>, <strong>Expenses &amp; Payables</strong>, and the rest — in the tab bar across the top of <strong>Money</strong>, or tap a card on the <strong>Overview</strong> tab. Either way you switch in place; the tab bar stays put, so getting from one Money screen to another is one tap, not a trip back to Money first.</p>
          ),
          answerText: 'Tap any tab — Budget Plan, Player Dues, Fundraisers, Expenses and Payables, and the rest — in the tab bar across the top of Money, or tap a card on the Overview tab. Either way you switch in place; the tab bar stays put, so getting from one Money screen to another is one tap, not a trip back to Money first.',
