          ...
          content: (
            <>
              ...
              <HelpDefs>
                ...
                <HelpDef term="Paying us back for a cost">The club returning money you fronted. It <strong>nets into the cost it repaid</strong> — shown in brackets on that line, dated the day the club decided — so the line finally says what the season really spent, and the money is never counted as income twice.</HelpDef>
              </HelpDefs>
