        ...
        },
        {
          ...
          content: (
            <>
              ...
              <p><strong>Add</strong> opens one form. Two buttons at the top say which way the money went — <strong>Expense</strong> or <strong>Income</strong> — and a tick box beside them says <strong>This is a refund</strong> when money came back on something the team paid for. Picked wrong? Press the other one; everything you&apos;ve typed comes with you. Money the team has <em>promised</em> but not paid is created one tab over, on <strong>Payables</strong>.</p>
