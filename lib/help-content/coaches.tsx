      ...
      subtopics: [
        {
          ...
          content: (
            <>
              ...
              <p><strong>Retiring tests.</strong> Retiring a test keeps every reading already logged against it — it just leaves the picker. If you retire your <em>last</em> active test, new sessions switch off again until you add or restore one, but <strong>every session you&rsquo;ve already run stays right where it was</strong> and stays open — and a retired test&rsquo;s saved results stay listed in those sessions, marked <em>retired</em>, read-only. The same goes for a player who leaves the team: their saved results stay on the sessions they took part in, marked as no longer on the roster.</p>
            </>
          ),
        },
        {
