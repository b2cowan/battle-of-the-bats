        ...
        },
        {
          ...
          answer: (
            <>
              ...
              <p>The old <em>Context</em> lines (depth chart, innings, attendance) left this section — they live on their own tabs of the record. <strong>Print summary (PDF)</strong> builds a one-page handout: goals, and one row per session with its headline and the attempts listed. No comparisons to other players, no share link. Every number compares the player only to themselves.</p>
    ...
    },
    {
      ...
      subtopics: [
        ...
        },
        {
          ...
          content: (
            <>
              ...
              <p><strong>Print summary (PDF)</strong> keeps its shape — goals and results with your organization&rsquo;s header — and lists one row per session with the headline and the attempts, never three rows for three sprints.</p>
            </>
          ),
        },
        {
        ...
        },
        {
          ...
          content: (
            <>
              <p>The <strong>Players</strong> view shows every player&rsquo;s focus areas or one chosen test in roster order, and Insights&rsquo; <strong>Development</strong> tab asks whether anyone is slipping through — one row per player, so the quiet kid at the end of the bench doesn&rsquo;t get overlooked. It&rsquo;s deliberately a coverage view, not a leaderboard. Tap a player&rsquo;s name on either and their record opens on Development; the back arrow returns you to the view — or the filtered report — you came from.</p>
              ...
              <p><strong>Underneath it</strong> you&rsquo;ll find the focus-area <strong>tags</strong> no practice has been about yet, and <strong>Practice review</strong> — filter to &ldquo;Hitting&rdquo; and you get every hitting practice, what was in it, and what you wrote afterwards. Each practice is labelled by what its records support: <em>Upcoming plan</em>, <em>Past plan · no recap</em> or <em>Recap recorded</em>. Only a recap says what happened. <strong>Open the plan</strong> works on a finished season too, read-only, so &ldquo;what did we do last spring?&rdquo; has an answer.</p>
        ...
        },
        {
          ...
          answer: (
            <>
              ...
              <p>The section used to be headed <em>Practices you&rsquo;ve run</em>, which claimed all three had been run. The tag filter and <strong>Open the plan</strong> work as before.</p>
      ...
      content: (
        <>
          ...
          <ul>
            ...
            <li><strong>Development</strong> — the coverage checklist: who has an active focus area, who was named in a practice plan, when each player was last measured — and <strong>Practice review</strong>, every planned practice labelled by what its records support.</li>
