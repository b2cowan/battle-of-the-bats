          ...
          content: (
            <>
              ...
              <HelpDefs>
                ...
                <HelpDef term="Planned funding">A budget line is an <strong>expense</strong> or one of three kinds of money in: <strong>fundraising</strong> (a drive — something the team sells), <strong>sponsorship</strong> (a sponsor or a grant, given directly), or <strong>other income</strong> (interest, a facility rebate, a plain donation — money nobody raised and no sponsor gave; you record its arrivals yourself, the way you record an expense). All of it is subtracted from what the season costs, so the plan tells you what players actually have to fund and dues are generated from that: budget $4,000 of funding against an $8,000 season and per player drops from $800 to $400. For fundraising, enter what you expect the <strong>team</strong> to keep — if a campaign pays part of what a player raises back to that player, it already lowers their own dues and shouldn&apos;t be counted twice.</HelpDef>
        ...
        },
        {
          ...
          content: (
            <>
              ...
              <HelpDefs>
                <HelpDef term="Revenue">Grouped by where the money comes from — <strong>Player dues</strong>, <strong>Fundraising</strong>, <strong>Sponsorships</strong>, <strong>Other income</strong> (arrivals you recorded yourself, and new money from your club), and <strong>Money back &amp; reimbursements</strong> when you have any. A group you have nothing in simply isn&apos;t there. <strong>Total revenue</strong> closes the band.</HelpDef>
              ...
              <HelpDefs>
                ...
                <HelpDef term="Sponsorships">Opens by sponsor. On the forward view, each pledge, with what it totals labelled <strong>Possible</strong> rather than Total — nobody has sent it yet.</HelpDef>
                <HelpDef term="Money back &amp; reimbursements">Opens to two sources, because they&apos;re two different events: money <strong>you recorded</strong>, and money <strong>the club repaid</strong>. Each record <strong>names the cost it repaid</strong> — these are the figures that behave differently here than on the Statement, and this is where you find that out. ⚠ <strong>Only repayments live here.</strong> A club <em>grant</em> is new money, not a refund, so it lands under <strong>Other income</strong> on the row you filed it against, marked <em>From the club</em>.</HelpDef>
