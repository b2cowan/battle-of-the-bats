        ...
        },
        {
          ...
          content: (
            <>
              ...
              <p><strong>Add</strong> opens one form, already set to the list you&apos;re looking at, and its first question is <em>what kind of entry is this</em> — <strong>a cost</strong>, <strong>income</strong>, or <strong>money back on something</strong> (see <em>Money coming in</em> below for the last two). Picked wrong? Switch at the top of the form and everything you&apos;ve typed comes with you.</p>
              <HelpDefs>
