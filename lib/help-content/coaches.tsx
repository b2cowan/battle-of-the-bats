    ...
    },
    {
      ...
      subtopics: [
        ...
        },
        {
          ...
          content: (
            <>
              <p><strong>Print the sheet</strong> gives you a <strong>run sheet</strong>: times down the left, your own notes at full width beside them, and each rotation grid sitting inside the block it belongs to with its group lists underneath — so whoever&rsquo;s running a station reads one region and has everything. A typical night is one page; a heavy one breaks honestly, and a sentence never splits across the break. It&rsquo;s on your team&rsquo;s paper, and it&rsquo;s a download you carry, never a link you share.</p>
              <p><strong>Then run it.</strong> Once the first block is written, <strong>Save as template…</strong> and <strong>Print the sheet</strong> appear above the sheet — a blank plan has nothing to keep or print, so it shows neither. <strong>Run practice</strong> is not on the plan page: it is the button on the <strong>Practice plans</strong> card and on your Overview once the practice is close enough to be tonight&rsquo;s, so the field screen is offered on the day and never for a practice three weeks out. See <em>Running a practice at the field</em> below.</p>
