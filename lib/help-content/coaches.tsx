        ...
        },
        {
          ...
          answer: (
            <>
              ...
              <p>To chase <em>one</em> family, open that player and use <strong>Remind</strong> in their panel. To chase everyone at once, use <strong>Send due reminders</strong> above the table — it emails about anything past due or due in the next 3 days.</p>
        ...
        },
        {
          ...
          content: (
            <>
              ...
              <p>The installment&apos;s amount and due date sit once in the column heading, and each cell answers one question: <em>is there anything still to send here?</em></p>
              <HelpDefs>
              ...
              <p><strong>Due next</strong> and <strong>Balance</strong> sit beside the player&apos;s name rather than out past the last installment, and on a wide screen they stay put while the installments scroll — so on a ten-installment season the two figures you act on are the ones that never leave the screen.</p>
