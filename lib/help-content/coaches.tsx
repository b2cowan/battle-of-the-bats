        ...
        },
        {
          ...
          content: (
            <>
              ...
              <p><strong>The filter strip</strong> narrows the book: <strong>All · Expenses · Income · Refunds · from Dues · from Fundraising · from Club</strong>, plus one budget item and your money tags. <strong>The Balance column disappears whenever you filter</strong> — a running total over some of the rows would look like your cash and wouldn&apos;t be it.</p>
              <p><strong>Include scheduled</strong> (off to start with) runs the book past today into what&apos;s coming: bills due, dues instalments, sponsor pledges, club amounts. Those rows are drawn as projections — dashed, italic, and chipped <em>Scheduled</em> — and money-out ones offer <strong>Mark paid</strong>. Anything still waiting on a decision, like a club request nobody has approved, never appears.</p>
