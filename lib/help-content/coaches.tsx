        ...
        },
        {
          ...
          content: (
            <>
              ...
              <p><strong>Editing a split line&apos;s total can&apos;t orphan its split any more.</strong> Change the total while a split exists and the form says so at once — <em>&ldquo;This line&apos;s split still adds to $5,200&rdquo;</em> — with <strong>Rescale the split evenly</strong> as the one-tap fix (it refits every chunk, keeping their proportions) and <strong>I&apos;ll adjust it myself</strong> for the coach who&apos;d rather retype. Either way, a split that no longer adds up never saves silently.</p>
