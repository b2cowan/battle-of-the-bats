      ...
      subtopics: [
        {
          ...
          content: (
            <>
              ...
              <p>One block is open at a time, so three blocks read as three lines, not three forms. A block you added from a drill opens straight onto the drill&rsquo;s own words instead of asking you to write them again. Reorder with the <strong>up and down arrows</strong> inside an open block rather than dragging, so it works with cold hands on a phone. Any sheet that opens over the plan — choosing players, picking a drill, saving a template — closes with <strong>Escape</strong> and puts you back where you were.</p>
            </>
          ),
        },
        {
