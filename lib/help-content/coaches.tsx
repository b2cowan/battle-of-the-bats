        ...
        },
        {
          ...
          content: (
            <>
              ...
              <p><strong>You never have to say whether something was budgeted.</strong> If your plan has a line for that category and item, it counts against it. If it doesn&apos;t, the cost appears on Budget vs. Actual as <strong>its own row, flagged &ldquo;not budgeted&rdquo;</strong>, inside its own category — so <em>&ldquo;what did we get charged for that we never planned?&rdquo;</em> finally has an answer.</p>
