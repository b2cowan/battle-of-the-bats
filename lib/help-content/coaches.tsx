      ...
      subtopics: [
        {
          ...
          content: (
            <>
              ...
              <p><strong>A block is a row that opens in place.</strong> Shut, it shows its title, its first line, who&rsquo;s in it and how many coaching points it carries; tap it and it opens where it is — description, goal, who&rsquo;s running it, who&rsquo;s in it, the <strong>coaching points</strong> (the two or three things you actually want to see), and its stations. One block is open at a time, so three blocks read as three lines, not three forms. Reorder with the <strong>up and down arrows</strong> inside an open block rather than dragging, so it works with cold hands on a phone.</p>
            </>
          ),
        },
        {
        ...
        },
        {
          ...
          content: (
            <>
              ...
              <p><strong>What everyone&rsquo;s working on is something you add to a plan</strong>, not part of every sheet. Beside <strong>Add a block</strong>, tap <em>what everyone&rsquo;s working on</em> and the section lands under the timeline: the roster in roster order, each player&rsquo;s focus areas beside the name, so putting three players on a station is a glance, not a memory test. It saves with the plan and prints on the sheet; the trash icon on its heading takes it off again, the same as a block. Save a plan that carries it as a template and every plan you start from that template carries it too — a team that uses focus areas sets it on <em>Standard Tuesday</em> once. Tap <strong>Choose players</strong> anywhere in the plan and you get the same list, with their focus areas beside them, whether or not the section is on the sheet.</p>
            </>
          ),
        },
        {
