    ...
    },
    {
      ...
      subtopics: [
        ...
        },
        {
          ...
          content: (
            <>
              <p>Under the guide card, <strong>Everything in Money</strong> lists all seven screens with a live figure beside each — grouped in the treasurer&apos;s order, so working through the list is working through your season in the order it happens:</p>
              <HelpDefs>
                <HelpDef term="Plan">Season Budget Plan</HelpDef>
                <HelpDef term="Collect">Player Dues · Fundraisers</HelpDef>
                <HelpDef term="Spend">Expenses &amp; Payables — plus Org Allocations and Payment Requests when a club or league runs your team</HelpDef>
                <HelpDef term="Review">Budget vs. Actual</HelpDef>
              </HelpDefs>
              <p>On a phone or a narrow window the list runs as one column top to bottom; on a wide screen it folds into two side by side — Plan and Collect on the left, Spend and Review on the right — so the whole list fits without scrolling. In season the same list appears under the dashboard as <strong>More in Money</strong>, carrying whatever the three cards above it don&apos;t already show. Either way, every screen is also one tap away in the <strong>tab bar</strong> across the top — hopping between Money screens never means leaving the page. On a club-run team, <strong>Org Allocations</strong> and <strong>Payment Requests</strong> also link to each other — what the club has billed you on one, and how you pay it back or claim a reimbursement on the other.</p>
        ...
        },
        {
          ...
          content: (
            <>
              ...
              <p>A parent buys the pizza, or covers a tournament entry on their own card. Record it as an ordinary expense and set <strong>Paid by</strong> to that family:</p>
              <HelpDefs>
        ...
        },
        {
          ...
          title: 'Payables & the payment schedule',
          content: (
            <>
