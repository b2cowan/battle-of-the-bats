    ...
    },
    {
      ...
      subtopics: [
        ...
        },
        {
          ...
          content: (
            <p>Staff and equipment work like your practice tags: start typing and pick from what your team has used before, or press <strong>+ Create</strong> to put a new name or item on the list for good. A name or item only has to be typed correctly once — pick it again on the next block, station or practice instead of retyping it, and a near-duplicate spelling never splits into two entries. This applies wherever staff and equipment show up: the practice&rsquo;s own equipment line, each block&rsquo;s staff (and its equipment, while it has no stations), and each station&rsquo;s who&rsquo;s-running-it and equipment.</p>
          ),
        },
        {
        ...
        },
        {
          ...
          content: (
            <>
              ...
              <p><strong>Afterwards, say how it went.</strong> <strong>How it went</strong> appears at the foot of the sheet once the practice has started — until then a line says it will — one note, written at home, about the <em>practice</em>: <em>&ldquo;tees were too crowded, run four next time&rdquo;</em>. It&rsquo;s for you and your staff; families never see it. It&rsquo;s deliberately about the practice and never about a player, and it&rsquo;s the thing that makes looking back at what you ran worth doing.</p>
            </>
          ),
        },
        {
      ...
      faqs: [
        ...
        },
        {
          ...
          answerText: 'You can type it, but adding a genuinely new name or item takes one more press, on a clearly labelled "+ Create" button. That extra step is deliberate: it keeps two spellings of the same name or item, like "Coach Dana" and "coach dana", from quietly becoming two different entries on your list. Typing searches what your team has already used; if it matches, tap it. If it is genuinely new, press "+ Create" and it joins your list for good, ready to pick again on any block, station or practice.',
          keywords: ['add staff', 'add equipment', 'staff list', 'equipment list', 'why cant i add staff', 'press enter', 'new staff name', 'new equipment item', 'duplicate staff name', 'two spellings', 'who runs it list', 'kit list', 'create staff', 'create equipment'],
          answer: (
            <>
              <p>You can type it — but adding a genuinely <strong>new</strong> name or item takes one more press, on a clearly labelled <strong>+ Create</strong> button.</p>
    ...
    },
    {
      ...
      subtopics: [
        ...
        },
        {
          ...
          content: (
            <>
              <p>Tap a station and you get just that patch of grass — the group with you now, what you&rsquo;re doing, <strong>what you&rsquo;re watching for</strong>, the coaching points, the setup, tonight&rsquo;s note, and who&rsquo;s coming to you next. If you&rsquo;re tagged on a station it&rsquo;s marked as yours. You can still look at what everyone else is doing.</p>
      ...
      faqs: [
        ...
        },
        {
          ...
          answerText: 'Yes. On the field screen, tap your station\'s row and you get "My station": the group with you right now, what you are doing, what you are watching for, the coaching points, the setup, any note the head coach left just for tonight, and who is coming to you next. If your name is tagged on a station it is marked as yours. You can still look at what the other stations are doing. It is read-only — there is nothing to fill in. Helpers see the same screen and the same buttons — Back, Next block and Rotate now move only their own phone — with a line above them naming the coach who moves the whole team.',
          keywords: ['my station', 'just my station', 'station view', 'i am on tees', 'what am i doing', 'what am i watching for', 'running a station', 'assistant station', 'station screen', 'helper station', 'parent running a station', 'helper buttons', 'who moves everyone on'],
          popular: true,
          answer: (
            <>
              ...
              <p>If your name is tagged on a station it&rsquo;s marked as yours. You can still look at what the other stations are doing.</p>
