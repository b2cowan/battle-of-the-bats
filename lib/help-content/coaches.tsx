        ...
        },
        {
          ...
          content: (
            <>
              ...
              <p><strong>The Schedule</strong> shows every dated payment a commitment is made of, and on a club-run team your organization&apos;s allocations too. Filter by <strong>Unpaid</strong>, <strong>Paid</strong> or <strong>All</strong>; overdue rows say how many days late they are. It&apos;s money going <em>out</em> only — player dues are money coming in and live on Player Dues, where the reminders that chase them are. The <strong>Next 30 days</strong> list on the Money Overview is the 30/60/90-day preview of the same commitments, interleaved with dues coming in; its rows open the <strong>Transactions</strong> book at that kind, with the scheduled rows showing, so you can see what the balance will be once they land.</p>
              <p><strong>A commitment billed in two parts reads as <em>&ldquo;installment 1 of 2&rdquo;</em> and <em>&ldquo;installment 2 of 2&rdquo;</em></strong> — the same wording on the Schedule, on <strong>Transactions</strong>, and behind a figure on <strong>Budget vs. Actual</strong>, so one payment reads the same wherever you meet it. A commitment paid in one go is just its own name, with nothing added. And one saved <strong>without a due date still appears here</strong>, dated the day you recorded it, so it can be found and paid rather than going quiet — give it a real date on its row whenever you know one.</p>
              <p><strong>Add a commitment</strong> asks four things: what it&apos;s for, how much is owed, when it&apos;s due, and what to call it. A commitment is always money going out. Anything with a due date belongs here — a tournament entry, a dome block, an umpire invoice, a uniform order. Open <strong>&ldquo;Split into a deposit and a balance&rdquo;</strong> when it&apos;s billed in two parts; each half then keeps its own due date and takes its own payments. The form says what saving will do: <strong>nothing moves</strong>. Cash on hand is unchanged and no family is affected — it joins your payment schedule, and that&apos;s all.</p>
              <p><strong>Recording a payment</strong> — from the Schedule, or from <strong>Payment details</strong> on a commitment&apos;s row — asks when the money left, how much of it moved, how it was paid, and (on a split bill) which installment it was for. <strong>Paying part of something works</strong>: record the $200 the club took today against a $600 entry and the row reads <em>$200 of $600 paid · $400 still owing</em>, status <strong>Partly paid</strong>, with the rest still on your schedule. Back-date a payment and the cost lands in that month rather than this one. A payment fills the oldest unpaid installment first and spills forward on its own — you never do that arithmetic, though you can point a payment at a particular installment when it was for one.</p>
              <p><strong>Every payment can be undone.</strong> Open <strong>Payment details</strong> on the commitment&apos;s row: each payment is listed with its date and method, and <strong>Undo</strong> beside it puts the books back by exactly that payment&apos;s amount — a mis-tap is a two-second fix, not something you live with. Paying <em>more</em> than what&apos;s owed saves too, and the record then says how far over it went — the book should read the way the bank statement does.</p>
