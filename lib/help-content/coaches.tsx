    ...
    },
    {
      ...
      content: (
        <>
          ...
          <p><strong>Nothing here loses your work.</strong> The longer Money forms — a budget line, an expense, a tournament payable, a payment request, fundraiser settings — ask before discarding if you close them with something typed in. <strong>Keep editing</strong> puts you back exactly where you were, with every field intact; <strong>Discard</strong> throws it away. A form you haven&apos;t touched just closes, with no question asked.</p>
      ...
      faqs: [
        ...
        },
        {
          ...
          answer: (
            <>
              <p>Yes — every Money page works on a phone. Lists of records (expenses, tournament payables, allocation instalments, fundraiser results) read as <strong>one card per item</strong> with a label on every line, so nothing runs off the edge.</p>
        ...
        },
        {
          ...
          answer: (
            <>
              <p>Because you closed a Money form with something typed into it. The longer forms — a <strong>budget line</strong> (especially one split into payment periods), an expense, a tournament payable, a payment request, or fundraiser settings — check before throwing anything away.</p>
