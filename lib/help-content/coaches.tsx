        ...
        },
        {
          ...
          content: (
            <>
              ...
              <p><strong>Then run it.</strong> Once the first block is written, <strong>Save as template…</strong> and <strong>Print the sheet</strong> appear above the sheet — a blank plan shows neither. <strong>Run practice</strong> sits first in the row on any day — before, during or after the practice — and lights up green on the day itself: the same door the <strong>Practice plans</strong> card, your Overview and the practice&rsquo;s Schedule panel offer. A tablet on the bench can read the sheet while your phone runs the field screen. See <em>Running a practice at the field</em> below.</p>
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <p>It&rsquo;s offered on <strong>every planned practice, any day</strong> — before, during or after — in four places: the <strong>Practice plans</strong> card and rows, your Overview, the practice&rsquo;s panel on the <strong>Schedule</strong>, and the plan page itself, where it&rsquo;s first in the row above the sheet. On the day of the practice it&rsquo;s the highlighted button; any other day it sits quietly beside <strong>Open the plan</strong>. It reads the same whenever you open it, and it never says a practice <em>ran</em>; nothing here records that.</p>
        </>
      ),
      subtopics: [
        {
