...
const coachesHelp: HelpPageContent = {
  ...
  sections: [
    ...
    },
    {
      ...
      summary: 'One block at a time on your phone, big enough to read in the sun — the block, the rotation, your own station, who’s where. No timer: you’re the clock.',
      ...
      faqs: [
        ...
        },
        {
          ...
          answerText: 'No, because it never kept time. The field screen is the plan one block at a time — what is on, who runs it, who is where, what comes next — and the length under each block is what the plan gave it, not a countdown. Start late, shorten a round, let a drill run: the screen just waits on you. It opens on the first block every time; if your phone reloads the page mid-practice, tap forward to where you are. Nothing about the plan changes and nothing is saved.',
          keywords: ['started late', 'running late', 'behind schedule', 'ran long', 'late start', 'practice started late', 'shorten a round', 'opens on the first block', 'phone reloaded'],
          answer: (
            <>
              ...
              <p>Start late, shorten a round, let a drill run: the screen just waits on you. It opens on the <strong>first block every time</strong>; if your phone reloads the page mid-practice, tap forward to where you are.</p>
