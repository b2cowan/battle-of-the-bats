    ...
    },
    {
      ...
      subtopics: [
        ...
        },
        {
          ...
          content: (
            <>
              <p>The <strong>Fundraising</strong> tab holds two kinds of money coming in, each in its own band, and the difference decides what you record. A <strong>fundraiser</strong> is something the whole team takes part in — a bottle drive, a chocolate sale — so it keeps a list of every player and what each one raised. A <strong>sponsorship</strong> is a promise from one business or grant, kept by cheques as they arrive — so it&apos;s a row in a small ledger: what was <strong>Pledged</strong>, what&apos;s <strong>In</strong>, what&apos;s still <strong>To come</strong>, and any <strong>Credits</strong> earned by the families who brought it in.</p>
              ...
              <p><strong>Record</strong> on a player&apos;s row — for anyone who has nothing logged yet — opens the same form the rest of Money uses, with this drive and this player already filled in, and shows a <strong>Where it lands</strong> preview before you save: exactly which of that family&apos;s bills the rebate will lower, and by how much. Save and the credit is on their dues straight away. A player who <em>already</em> has an amount shows <strong>Edit amount</strong> instead, which opens the row in place to correct the figure, the date it arrived or the note.</p>
              ...
              <p>A fundraiser or a sponsorship can carry <strong>money tags</strong> — the same labels you put on expenses, so &ldquo;Winter dome&rdquo; means one thing whether the money went out or came in. Tags live on the record, not on the list, so pick them when you create it, or change them later in a drive&apos;s <strong>Settings</strong> or a sponsor&apos;s <strong>Edit</strong>. They come through on the export — with sponsor money split into <strong>Received</strong> and <strong>Pledged</strong> columns — which is what lets a spreadsheet show what a label cost you <em>and</em> what it brought in.</p>
        ...
        },
        {
          ...
          content: (
            <>
              ...
              <p><strong>Say what each one is for.</strong> Both a club bill and a request name a <strong>category and item</strong> from your own budget, the same search box the money form uses — and that is what puts club money on <strong>Budget vs. Actual</strong>. Anything left unfiled still counts in your cash, but lands in the report&apos;s <em>Not itemized</em> row. Both pick from your <em>spending</em> words even when the money is coming in: a club covering a $325 entry fee is paying you back for a cost, so it lands against that cost rather than counting as income twice.</p>
        ...
        },
        {
          ...
          content: (
            <>
              ...
              <HelpDefs>
                <HelpDef term="Revenue">Grouped by where the money comes from — <strong>Player dues</strong>, <strong>Fundraising</strong>, <strong>Sponsorships</strong>, <strong>Other income</strong>, and <strong>Money back &amp; reimbursements</strong> when you have any. A group you have nothing in simply isn&apos;t there. <strong>Total revenue</strong> closes the band.</HelpDef>
              ...
              <HelpDefs>
                ...
                <HelpDef term="Scheduled">The <strong>forward view</strong>: dues installments still to come, sponsor pledges and anything you&apos;ve asked the club for, against what you still owe. A bill you&apos;ve settled leaves this view entirely (it&apos;s <em>Actual</em> now), and a part-paid one shows only the remainder — the same figure the Ledger&apos;s owed views and <em>Next 30 days</em> quote. The running balance here starts from the money you actually have today.</HelpDef>
