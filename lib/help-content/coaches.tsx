    ...
    },
    {
          ...
          content: (
            <>
              ...
              <HelpDefs>
                ...
                <HelpDef term="Fundraiser money came in">Logs it to the drive and credits the player, same as recording it from the drive&apos;s room on Fundraising.</HelpDef>
                <HelpDef term="A sponsor came through">Asks <strong>Which sponsor?</strong> — your pledges first, or <em>a new sponsor</em>, which records them right there: name, amount, the day it arrived, and which families to credit ($ or %, prefilled with your team&apos;s standard share). It lands on Fundraising exactly as if created there. Nothing arrived yet? That is a different answer — see <strong>A sponsor promised us money</strong> below.</HelpDef>
                ...
                <HelpDef term="Other money in">Anything else the team earned or was given — posts to the Ledger as Income.</HelpDef>
      ...
      faqs: [
        ...
        },
        {
          ...
          popular: true,
          answer: (
            <p><strong>+ Record</strong> sits at the top of Money beside Import, whichever tab you&apos;re on (on a phone it&apos;s the <strong>+</strong> next to the &ldquo;?&rdquo;) — so you can write down money that moved without hunting for the right tab first. Press it and answer one question, <strong>&ldquo;What happened?&rdquo;</strong>, from eight plain-language choices (dues paid, fundraiser money, a sponsor, money back on a cost, other money in; paying for something, settling up with the club, paying a family back), and it lands the record exactly where its home tab would — the player&apos;s bill on Player Dues, the drive&apos;s room, the club installment marked paid, and so on. On a tab that&apos;s about one kind of event it opens already answered for that tab, and you can change it. <strong>Every other door now opens the same form</strong>: a family&apos;s <strong>Record</strong>, a drive room&apos;s <strong>Record</strong>, a bill&apos;s <strong>Record</strong> — each with what it already knows <strong>stated rather than offered</strong>, so a form opened on one record can&apos;t be saved against another. A door states only what it actually knows: a drive&apos;s room states the fundraiser and still asks which player raised the money. The one-tap <strong>Record as paid</strong> shortcuts on dues and club installments still don&apos;t stop to ask, editing still happens where the record lives, and Payables keeps <strong>Add a commitment</strong> for money you&apos;ve agreed to pay but haven&apos;t yet.</p>
          ),
          answerText: '+ Record sits at the top of Money beside Import on every tab — on a phone it is the + next to the "?" — so you can write down money that moved without hunting for the right tab first. Press it and answer one question, "What happened?", from eight plain-language choices (dues paid, fundraiser money, a sponsor, money back on a cost, other money in; paying for something, settling up with the club, paying a family back), and it lands the record exactly where its home tab would — the player\'s bill on Player Dues, the drive\'s room, the club installment marked paid, and so on. On a tab that is about one kind of event it opens already answered for that tab, and you can change it. Every other door opens the same form: a family\'s Record, a drive room\'s Record, a bill\'s Record, each with what it already knows stated rather than offered, so a form opened on one record cannot be saved against another. A door states only what it actually knows: a drive room states the fundraiser and still asks which player raised the money. The one-tap Record as paid shortcuts on dues and club installments still do not stop to ask, editing still happens where the record lives, and Payables keeps Add a commitment for money you have agreed to pay but have not yet.',
          keywords: ['record button', 'what does record do', 'record money', 'what happened', 'one door', 'write down money', 'log money quickly', 'record from any tab', 'recording conversation', 'cant change what happened', 'what happened is greyed out', 'no what happened dropdown', 'cant change the drive', 'which drive missing', 'form opened on the wrong record', 'wrong drive', 'wrong family', 'stated not offered'],
        },
        {
