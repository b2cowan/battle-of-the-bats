        ...
        },
        {
          ...
          content: (
            <>
              ...
              <p><strong>Tap any bill to open it</strong> — including one that is fully paid. The panel shows the whole thing in one place: every scheduled payment with its own state, every payment you have recorded, and the one figure that matters. <strong>Edit</strong> and <strong>Delete</strong> are there too, on a settled bill as much as an unpaid one. On a bill with a single payment, <strong>Add an installment</strong> splits it in two.</p>
              <p><strong>Add a commitment</strong> asks what it&apos;s for, how much is owed, when it&apos;s due and what to call it — a tournament entry, a dome block, an umpire invoice, a uniform order. Open <strong>&ldquo;Split into a deposit and a balance&rdquo;</strong> when it&apos;s billed in two parts; each half keeps its own due date and takes its own payments, and reads as <em>&ldquo;installment 1 of 2&rdquo;</em> here, on <strong>Transactions</strong> and on <strong>Budget vs. Actual</strong>, so one payment looks the same wherever you meet it. Saving <strong>moves nothing</strong> — cash on hand is unchanged and no family is affected.</p>
