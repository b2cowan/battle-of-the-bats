        ...
        },
        {
          ...
          content: (
            <>
              ...
              <HelpDefs>
                <HelpDef term="A sponsor&apos;s room">Three figures up top — <strong>Pledged</strong>, <strong>Arrived</strong>, <strong>To come</strong> (with the expected-by date, in red once it has passed) — then two panels side by side: <strong>Cheques</strong>, every arrival with its date and how it came, and <strong>Credited to players</strong>, the split, editable right there. No separate page.</HelpDef>
                ...
                <HelpDef term="Undo, on a cheque">Takes that cheque back off the books along with the credit it gave out; undo the last one and the sponsor returns to being a pledge.</HelpDef>
                <HelpDef term="Credited to players">The split lives in the room, not behind Edit. Change a family or a share and <strong>Save split</strong> appears; every cheque already in is re-figured against the new split when you press it. If the change would shrink a family&apos;s credit below what has already been paid out to them, the room says so under the split, before the button will save.</HelpDef>
                ...
                <HelpDef term="Delete this sponsorship">At the foot of the room. A pledge with nothing arrived deletes on a plain confirm and no money moves; once a cheque has landed, pressing it explains instead — how much is on the books, and that the way out is <strong>Undo</strong> on each cheque first.</HelpDef>
              </HelpDefs>
              ...
              <p><strong>Record</strong>, in the room, opens the same form the rest of Money uses with this drive already filled in. It asks which player — offering only those with nothing logged yet — and says plainly, before you save, what the family will be credited. Save and the credit is on their dues straight away; where it landed reads on the family&apos;s own dues screen. <strong>Edit</strong>, on a logged line, corrects the figure, the day it arrived or the note in a small window over the room; the books entry and the family&apos;s credit follow it.</p>
