      ...
      content: (
        <>
          ...
          <ul>
            ...
            <li><strong>A side panel, on a wide screen</strong> — <strong>This week</strong> (what&rsquo;s on in the next seven days, plus any player birthdays) and <strong>Waiting on you</strong> (dues overdue, players with no guardian email, a next game with no lineup). It&rsquo;s there to be glanced at, so it has no buttons — each line just takes you to the place that handles it, and a group vanishes when there&rsquo;s nothing in it. On a phone it moves below your tiles. You&rsquo;ll see the same kind of panel on the <strong>lineup builder</strong> (who isn&rsquo;t placed yet, with their attendance, and the headcount) and on <strong>Player Dues</strong> (collected, outstanding and next due, beside the rows instead of scrolling away above them).</li>
