    ...
    },
    {
      ...
      faqs: [
        ...
        },
        {
          ...
          popular: true,
          answerText: 'Nothing is lost. Once a player\'s history is linked (confirmed by you, or linked automatically by Start next season), their Skills & Goals tab gains a shut Previous seasons fold at its foot, titled by the season\'s own name ("2025 Season · Archive"), that opens to that season\'s goals, then its results, then attendance, exactly as they were recorded. It is deliberately a scrapbook, not a scoreboard: past seasons sit side by side and the app never computes "better or worse than last year" — youth seasons are not comparable. On a newly linked player, the head coach also gets a one-time offer: bring forward the focus areas they were working on last season? You can look first (View record), bring them forward (they join this season as "Working on it"), or start fresh. A previous season\x27s focus areas and results are read-only: nothing from this season can add to, edit or delete them ("This player belongs to a past season, which is read-only"). Results never carry over — last season\'s numbers stay in that season\'s archive so this season\'s trend lines stay honest. Either answer is remembered and the offer never re-appears. The Development report in Insights (the Development tab) shows a Returning player column so you can see at a glance whose past seasons are connected.',
          keywords: ['previous seasons', 'archive', 'history', 'last season', 'bring forward', 'carry forward', 'start fresh', 'rollover', 'new season', 'notes disappeared', 'keep notes', 'season history', 'development history', 'scrapbook', 'read-only past season', 'belongs to a past season', 'edit last season'],
          answer: (
            <>
              ...
              <p>On a newly linked player, the head coach also gets a <strong>one-time offer</strong>: bring forward the focus areas they were working on last season? You can look first (<strong>View record</strong>), <strong>bring them forward</strong> (they join this season as &ldquo;Working on it&rdquo;), or <strong>start fresh</strong>. <strong>Results never carry over</strong> — last season&apos;s numbers stay in that season&apos;s archive so this season&apos;s trend lines stay honest. Either answer is remembered, and the offer never re-appears.</p>
              <p>A previous season&apos;s focus areas and results are <strong>read-only</strong> — you can read them in the archive, but nothing from this season can add to, edit or delete them. Anything that tries is refused with <em>&ldquo;This player belongs to a past season, which is read-only.&rdquo;</em></p>
