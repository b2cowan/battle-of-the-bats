  ...
  sections: [
    {
      ...
      searchText: 'coaches portal free team home tournament participant year round roster schedule fees announcements premium upgrade what is overview schedule tile next game live tournament game live score fan view public site',
      content: (
        <>
          ...
          <p>The Overview&apos;s <strong>Schedule</strong> tile shows your own next practice or game once you&apos;ve added events. Haven&apos;t added any? If your team is in a tournament with a published schedule, the tile borrows your next tournament game instead — and during a game it shows the <strong>live score</strong> — so game day is never a blank &ldquo;None.&rdquo; A quiet <strong>Fan view</strong> link under your tournament history jumps to the event&apos;s public site: the schedule, live scores, and standings exactly as families see them.</p>
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <p>A <strong>Fan view</strong> link on each entry (and on your team Overview) jumps to the tournament&apos;s public site — the schedule, live scores, and standings exactly as families see them.</p>
        </>
      ),
      faqs: [
        {
