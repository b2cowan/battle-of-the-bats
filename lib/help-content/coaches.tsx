          ...
          content: (
            <>
              ...
              <HelpDefs>
                ...
                <HelpDef term="Leaving it blank">Records the cost as unpaid. It waits in the scheduled block above today, with a <strong>Mark paid</strong> button that reopens the form and asks when the money went.</HelpDef>
