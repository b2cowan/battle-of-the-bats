        ...
        },
        {
          ...
          answer: (
            <>
              ...
              <p><strong>Sensitive access</strong> is its own group beneath and covers team money, family contact details and player birthdates, internal notes, sending announcements, tryouts, and managing the staff. The group&apos;s heading says how many are currently granted, so nothing is ever hidden from you. <strong>Every one of them asks you to confirm before you grant it</strong> — each exposes something personal: your team&apos;s finances, your families&apos; details, private staff notes, the ability to email every parent, the contact details of children still trying out, or the power to change what others can open. <strong>Taking access away is always instant</strong> and never asks.</p>
          ...
          keywords: ['assistant coach', 'assistant permissions', 'what can my assistant do', 'staff permissions', 'grant access', 'money access', 'contacts and birthdates', 'send announcements', 'sensitive access', 'standard access', 'confirm before granting', 'remove assistant', 'take access away', 'restrict assistant', 'internal notes access', 'tryouts access', 'signed forms access', 'medical consent access', 'waiver access', 'documents and contacts', 'why did it ask me to confirm'],
        },
      ],
    },
    {
          ...
          content: (
            <>
              ...
              <HelpDefs>
                ...
                <HelpDef term="Team manager">Runs the team off the field — money, forms, family emails, the staff list. Not the lineup. Starts with the schedule (view and edit), the staff chat, documents (manage), team money (view and edit), contacts &amp; birthdates, emailing families and <strong>Manage staff</strong> (the only role that starts with it); attendance and lineups off.</HelpDef>
