    ...
    },
    {
      ...
      subtopics: [
        ...
        },
        {
          ...
          content: (
            <>
              ...
              <p><strong>One button, three answers.</strong> <strong>Add</strong> on Expenses &amp; Payables opens one form, already set to whichever list you&apos;re looking at, and its first question is <em>what kind of entry is this</em> — <strong>a cost</strong>, <strong>income</strong>, or <strong>money back on something</strong> (see <em>Money coming in</em> below for the last two). Choose <strong>a cost</strong> and a second question appears: <strong>already paid</strong>, or <strong>promised, not paid yet</strong>. The quick test: if it has a due date it&apos;s a payable, and payables are what show on your Payment schedule. Picked wrong? Switch at the top of the form and everything you&apos;ve typed comes with you.</p>
              <p><strong>Fixing a mistake.</strong> Tap the pencil on any row — or the row itself — to reopen it. Names, notes, tags and <strong>what the cost is</strong> (its category and item) can always be changed, even after it&apos;s been paid — re-filing a past cost moves no money. Once something is <strong>marked paid</strong> its amount locks, because that figure is already on the team&apos;s books; the form shows the amount with the reason and points you at the fix. <strong>Delete</strong> sits at the bottom of the same form. Deleting something already paid puts the money back and tells you the exact amount first, so a mistyped $1,300 is a correction rather than something you live with all season. If a family paid out of pocket, deleting also removes the credit the team owed them — the form says so before you confirm.</p>
        ...
        },
        {
          ...
          content: (
            <>
              <p><strong>The <em>Money in</em> tab on Expenses &amp; Payables holds every arrival</strong> — and there are two kinds, because money arriving is not one thing. Both use the same <strong>Add</strong> form and the same category + item as a cost, so what you earn lines up against what you spend, row for row.</p>
              <HelpDefs>
                ...
                <HelpDef term="Money back on something">A <strong>refund, credit or reimbursement</strong> of something already recorded — a cancelled entry refunded, a vendor credit, the club paying back a permit you fronted. It <strong>reduces the row it repaid</strong> instead of becoming a row of its own.</HelpDef>
              </HelpDefs>
        ...
        },
        {
          ...
          content: (
            <>
              ...
              <HelpNote variant="info" title="Your club, or an outside supplier?">Allocations and Payments are always money moving between your team and your own club. Anything you owe someone outside it — a dome block, an umpire invoice, a tournament organizer — belongs on <strong>Expenses &amp; Payables</strong> instead.</HelpNote>
            </>
          ),
        },
        {
      ...
      faqs: [
        ...
        },
        {
          ...
          answer: (
            <p>Tap any tab — <strong>Budget Plan</strong>, <strong>Player Dues</strong>, <strong>Fundraising</strong>, <strong>Expenses &amp; Payables</strong>, and the rest — in the tab bar across the top of <strong>Money</strong>, or any link on the <strong>Overview</strong> tab: every card&apos;s footer links and every row in the More in Money list lead to the screen that owns the number. Either way you switch in place; the tab bar stays put, so getting from one Money screen to another is one tap, not a trip back to Money first. Overview lists <strong>Fundraisers</strong> and <strong>Sponsorships</strong> as two rows — both open Fundraising, each showing just that kind.</p>
          ),
          answerText: 'Tap any tab — Budget Plan, Player Dues, Fundraising, Expenses and Payables, and the rest — in the tab bar across the top of Money, or any link on the Overview tab: every card’s footer links and every row in the More in Money list lead to the screen that owns the number. Either way you switch in place; the tab bar stays put, so getting from one Money screen to another is one tap, not a trip back to Money first. Overview lists Fundraisers and Sponsorships as two rows — both open Fundraising, each showing just that kind.',
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <p>The previous season becomes <strong>read-only history</strong> — a season you can still read, not just a summary line. Switch to it with the <strong>season chip</strong> beside any page title and the portal describes that year: roster, schedule, money records, documents, tryout history, and the whole of <strong>Insights</strong> (in the <strong>Season</strong> menu — once called <em>Season Review</em>). Nothing there can be edited. <strong>&ldquo;How are we doing?&rdquo;</strong> also keeps a <strong>Past seasons</strong> list at its foot — each year&apos;s record, roster size and (with money access) dues and expenses. There&apos;s no year-over-year comparison on purpose: teams change divisions and opponents each year, so the seasons sit side by side as a scrapbook, not a scoreboard. You land in the new season with a short summary of what carried over and anything worth a second look — confirming carried-over fee due dates, say, or re-collecting waivers.</p>
      ...
      faqs: [
        ...
        },
        {
          ...
          keywords: ['past season insights', 'last year insights', 'finished season insights', 'archive insights', 'old season report', 'previous season report', 'insights past season', 'why no playing time last year', 'playing time missing archive', 'opponents missing archive', 'no ask bar past season', 'attendance past season', 'where is attendance archive', 'team not found insights', 'season chip', 'switch season insights', 'left the team', 'no longer coach'],
          answer: (
            <>
              <p>Yes. Switch season with the <strong>chip beside the page title</strong> and the whole Insights page describes that year instead — its scoreboard, what stood out, and the report tiles. Every tile keeps you in that season, and the year is named on screen so you always know which one you&rsquo;re reading.</p>
              <p><strong>This works even if you no longer coach the team.</strong> If you ran it that season, you can open that season — and what you see is what your access allowed you <em>at the time</em>. An assistant who had no money access last year still sees no money figures for last year, even if they have money access on a team today.</p>
              <p><strong>Two tiles are deliberately missing.</strong> <em>&ldquo;Where is playing time going?&rdquo;</em> and <em>&ldquo;Who did we play?&rdquo;</em> don&rsquo;t appear in a finished season. Playing-time figures are recalculated from your saved lineups each time you open them, and your opponent notes are the book you keep <em>today</em> — neither can promise to show a past season as you actually saw it, so we don&rsquo;t offer them rather than quietly showing this year&rsquo;s answer under last year&rsquo;s heading. <strong>Ask about your team</strong> is live-season only for the same reason.</p>
              <p><strong>Attendance has no menu line of its own in a finished season</strong> — it&rsquo;s reached through Insights as <em>&ldquo;Who&rsquo;s showing up?&rdquo;</em>, exactly as it is in a live one.</p>
            </>
          ),
        },
        {
        ...
        },
        {
          ...
          answer: (
            <>
              ...
              <p><strong>A past season&rsquo;s awards are here too.</strong> Switch season with the chip beside the page title and the leaderboard shows that year. A finished season is a record, so there&rsquo;s no <em>Give an award</em>, no <em>Manage award types</em> and no way to remove a row — but you can still <strong>print a certificate</strong>, and it names the season the award was won in.</p>
            </>
          ),
        },
        {
