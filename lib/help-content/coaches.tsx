          ...
          content: (
            <>
              ...
              <HelpDefs>
                ...
                <HelpDef term="Expected funding">A budget line is an <strong>expense</strong> or one of three kinds of money in: <strong>expected fundraising</strong> (a drive — something the team sells), <strong>expected sponsorship</strong> (a sponsor or a grant, given directly), or <strong>expected other income</strong> (interest, a facility rebate, a plain donation — money nobody raised and no sponsor gave; you record its arrivals yourself, the way you record an expense). All of it is subtracted from what the season costs, so the plan tells you what players actually have to fund and dues are generated from that: budget $4,000 of funding against an $8,000 season and per player drops from $800 to $400. For fundraising, enter what you expect the <strong>team</strong> to keep — if a campaign pays part of what a player raises back to that player, it already lowers their own dues and shouldn&apos;t be counted twice.</HelpDef>
        ...
        },
        {
          ...
          content: (
            <>
              ...
              <HelpDefs>
                <HelpDef term="Budget">Your <strong>plan</strong> — the dues installments you set and your expected funding on one side, the months you gave your costs on the other. It shows whether the plan itself runs short, months before the money does.</HelpDef>
        ...
        },
        {
          ...
          answer: (
            <>
              ...
              <ul>
                <li><strong>Split the budget evenly</strong> — your cost lines, less any expected funding, divided across the roster.</li>
