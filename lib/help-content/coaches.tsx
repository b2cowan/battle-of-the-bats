    ...
    },
    {
      ...
      faqs: [
        ...
        },
        {
          ...
          answer: (
            <>
              <p>Open any player from your <strong>Roster</strong> and find the <strong>Development</strong> section. It has <strong>four views</strong> across the top — <strong>Goals · Results · Observations · Previous seasons</strong> — one at a time inside the section; the record&rsquo;s own tabs are unchanged.</p>
              <HelpDefs>
    ...
    },
    {
      ...
      subtopics: [
        ...
        },
        {
          ...
          content: (
            <>
              <p>Open a player from the Roster and find the <strong>Development</strong> section on <em>This season</em>. It has four views across the top, one at a time; the record&rsquo;s own tabs are unchanged. The returning-player card and the carry-forward offer sit above the views; the tryout snapshot heads Goals.</p>
              <HelpDefs>
                ...
                <HelpDef term="Previous seasons">The read-only scrapbook of linked earlier seasons. Attendance and playing time stay on their own tabs of the record — the old <em>Context</em> lines left this section.</HelpDef>
              </HelpDefs>
      ...
      subtopics: [
        {
          ...
          content: (
            <>
              <p>Open any player from your <strong>Roster</strong> and you&rsquo;ll find <strong>Family season recap</strong> with a <strong>Preview</strong> control. It shows exactly what that player&rsquo;s parent or guardian will read once your season closes — you&rsquo;re looking at their screen, not a summary of it.</p>
