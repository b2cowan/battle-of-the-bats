          ...
          content: (
            <>
              ...
              <HelpNote variant="info" title="Changing a definition later">
                <p>A rename, a new aim or a new method keeps the series. Changing the <strong>unit</strong> on a test that already has results starts a <em>new</em> definition and retires this one — the sheet offers you the choice — because a km/h series and an mph series must never be drawn as one line.</p>
              </HelpNote>
              <p><strong>Retire</strong> and <strong>Restore</strong> sit in the sheet&rsquo;s footer. Retired metrics stay on the list under <em>Retired (N)</em>, each row saying <em>retired</em> and what replaced it. Open one and it reads as a record — only the name editable, with Restore beside Cancel. A replaced metric cannot be restored; its successor carries the name.</p>
            </>
          ),
        },
        {
