        ...
        },
        {
          ...
          content: (
            <>
              ...
              <p><strong>Why does everything look behind mid-season?</strong> The same sentence says so: both columns compare a <em>whole season&rsquo;s</em> plan against what has <em>moved so far</em>, so until the season is finished the Actual column runs short on almost every row. That is the calendar, not a problem.</p>
