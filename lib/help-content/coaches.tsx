          ...
          content: (
            <>
              ...
              <HelpDefs>
                ...
                <HelpDef term="Expenses">Your budget categories exactly as you set them up, plus <strong>Paid back to families</strong> for money you&apos;ve handed back. <strong>Total expenses</strong> closes the band.</HelpDef>
              ...
              <p><strong>Why can this differ from the Statement?</strong> Because they answer two different questions, and both answers are right. The Statement is what your <em>season spent</em>; Months is what your <em>cash did</em>. So Months adds money you paid back to families, leaves out a cost a family paid a vendor directly (your season spent it, but no team money moved — it lands here the day you pay that family back), and shows money back as revenue instead of quietly shrinking the cost it repaid. The screen says so under the grid.</p>
              ...
              <HelpDefs>
                ...
                <HelpDef term="Paid back to families">Opens by family, mirroring dues, with the <em>reason</em> on each payment&apos;s own line — an overpaid installment, a shared surplus, a cashed-out credit.</HelpDef>
              </HelpDefs>
