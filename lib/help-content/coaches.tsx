        ...
        },
        {
          ...
          content: (
            <>
              ...
              <p><strong>Over budget is good news on income and bad news on a cost</strong>, so the wording changes with the section: revenue reads <em>+$400</em> or <em>−$160</em>; costs read <em>$150 under</em> or <em>$160 over</em> — and a quiet key under the table says so. A figure in <strong>brackets</strong> is a negative — most often a refund filed against the wrong item, which is exactly why it&apos;s shown rather than hidden or flipped; a cost row holding <em>only</em> money back reads <strong>&ldquo;refund only&rdquo;</strong> rather than pretending to be an underspend. A row nobody budgeted has a <strong>dash</strong> where its budget figure would be, on a faintly tinted row &mdash; the empty figure is the whole answer, so there&apos;s no label to look for.</p>
