        ...
        },
        {
          ...
          content: (
            <>
              ...
              <p>Above the grid, the <strong>Collection schedule</strong> band gives each installment&apos;s progress; below it, the last row totals what to collect now and the season&apos;s balance owing under the columns those figures belong to.</p>
            </>
          ),
        },
        {
