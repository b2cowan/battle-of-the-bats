        ...
        },
        {
          ...
          content: (
            <>
              ...
              <p><strong>Tap any bill to open it</strong> — including one that is fully paid. The panel shows the whole thing in one place: every scheduled payment with its own state, every payment you have recorded, and the one figure that matters. <strong>Edit</strong> and <strong>Delete</strong> are there too, on a settled bill as much as an unpaid one. <strong>Add an installment</strong> puts another dated payment on any bill, however many it already has. Each scheduled payment also has its own <strong>Change</strong> and <strong>Remove</strong> — <a href="#premium-money-repeating">how far those reach</a> is its own answer.</p>
