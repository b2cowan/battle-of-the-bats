        ...
        },
        {
          ...
          answer: (
            <>
              ...
              <p><strong>Everyday coaching</strong> is up front — seeing the schedule, <strong>changing</strong> the schedule, attendance, lineups, <strong>development</strong> (off until you switch it on — it hands over recording results and defining tests), <strong>staff chat</strong>, viewing the roster, and <strong>documents</strong> (the blank team forms your organization publishes). These are what an assistant is normally invited to do, and they save the moment you tap them.</p>
    ...
    },
    {
      ...
      subtopics: [
        ...
        },
        {
          ...
          content: (
            <>
              <p><strong>Only a head coach</strong> can invite, adjust, or remove anyone. Adding and editing players and closing the season stay with the head coach too; Skills &amp; Goals can be handed to an assistant with the <strong>Development</strong> switch.</p>
