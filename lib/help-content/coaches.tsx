        ...
        },
        {
          ...
          content: (
            <>
              ...
              <p><strong>Add players yourself.</strong> Use <strong>Add player</strong> for anyone not already on the list — a walk-up on the day, or your whole squad if you took registrations outside FieldLogicHQ. Just a name is enough; guardian details can wait. They&apos;re checked in on the spot.</p>
            </>
          ),
        },
        {
