    ...
    },
    {
      ...
      faqs: [
        ...
        },
        {
          ...
          answerText: 'Because a goal on its own does not tell anyone what happens at six o clock. Practice plans marks a practice "Plan set" once it has at least one block; a goal, an equipment note or a practice type is saved but does not count on its own, so the practice stays in the "Needs a plan" count (and the card, if it is your next practice, keeps offering "Plan this practice"). Nothing you typed is lost — open the practice and it is all still there, waiting for its first block.',
          ...
          answer: (
            <>
              ...
              <p>Practice plans marks a practice <strong>Plan set</strong> once it has at least one <strong>block</strong>. A goal, an equipment note or a practice type is saved the moment you type it, but none of them count on their own — so the practice stays in the <strong>Needs a plan</strong> count, and if it&rsquo;s your next practice the card keeps offering <strong>Plan this practice</strong>, which is where you want it.</p>
