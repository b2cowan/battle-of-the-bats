        ...
        },
        {
          ...
          content: (
            <>
              ...
              <p><strong>One toggle changes what every cell shows</strong>, on both bands:</p>
              <HelpDefs>
                ...
                <HelpDef term="Scheduled">The <strong>forward view</strong>: dues installments still to come, sponsor pledges and anything you&apos;ve asked the club for, against what you still owe — your own unpaid bills <em>and</em> the installments your club has billed you, each in the month it falls due, under whatever that bill is filed as. A bill you&apos;ve settled leaves this view entirely (it&apos;s <em>Actual</em> now), and a part-paid one shows only the remainder — the same figure the Ledger&apos;s owed views and <em>Next 30 days</em> quote, so the three finally agree. The running balance here starts from the money you actually have today.</HelpDef>
                <HelpDef term="Actual">Real <strong>cash</strong> — every dollar that arrived and every dollar that left, in the month it moved. If the season was handed money on day one, that&apos;s where the balance starts.</HelpDef>
                <HelpDef term="Difference">Your plan against what really happened, for months that have already been. A <strong>positive figure is good news on both bands</strong>: revenue that came in <em>ahead</em>, or spending that came in <em>under</em>. A month still ahead shows a dash — money nobody has spent yet isn&apos;t a saving, and dues nobody owes yet aren&apos;t late.</HelpDef>
              </HelpDefs>
              ...
              <p><strong>Why can this differ from the Statement?</strong> Because they answer two different questions, and both answers are right. The Statement is what your <em>season spent</em>; Months is what your <em>cash did</em>. So Months shows money you paid back to families in its own band, leaves out a cost a family paid a vendor directly (your season spent it, but no team money moved), and shows money back as revenue instead of quietly shrinking the cost it repaid. <strong>The screen does the arithmetic for the two that move the figure</strong>: under the grid, a line starting &ldquo;Headroom counts…&rdquo; opens and walks money back and family-paid costs from one total to the other. Money returned to families needs no line there — it was never part of either figure.</p>
