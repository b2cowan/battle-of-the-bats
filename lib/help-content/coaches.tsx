    ...
    },
    {
      ...
      subtopics: [
          ...
          content: (
            <>
              ...
              <HelpDefs>
                ...
                <HelpDef term="Spend">Payables and Transactions — plus Club, when a club or league runs your team</HelpDef>
          ...
          content: (
            <>
              ...
              <HelpDefs>
                ...
                <HelpDef term="Money back on something we paid">A refund, credit or reimbursement — reduces the cost it repays, on Transactions.</HelpDef>
                <HelpDef term="Other money in">Anything else the team earned or was given — posts to Transactions as Income.</HelpDef>
              ...
              <HelpNote variant="tip" title="Record is for money that has already moved">Everything you record here has a <strong>Date paid</strong> or <strong>Date received</strong>, and it can&apos;t be in the future. Something you&apos;ve <em>agreed</em> to pay but haven&apos;t yet is a <strong>payment schedule</strong>, not a transaction — make it with <strong>Add a commitment</strong> on Payables. Type a future date here by mistake and the form says so and offers you that door, carrying your amount, item and description across.</HelpNote>
              ...
              <p>Two kinds of button deliberately did <strong>not</strong> change. The one-tap shortcuts still don&apos;t stop to ask: <strong>Record as paid</strong> / <strong>Record rest as paid</strong> on a dues installment, and <strong>Record as paid</strong> on a club installment. And <strong>editing</strong> stays where the record lives — the pencil on a dues receipt, <strong>Edit amount</strong> on a drive row — because correcting something is a different act from writing it down. Payables keeps its own <strong>Add a commitment</strong>, which is how payment schedules are made.</p>
              <p>One payment-method list now shows everywhere you record money by hand — dues, payouts, expenses and payables all offer <strong>E-Transfer, Cash, Cheque, Card</strong> and <strong>Other</strong>, so a coach never has to remember which screen spells e-transfer differently.</p>
            </>
          ),
        },
        {
        ...
        },
        {
          ...
          title: 'Transactions: the team’s dated book',
          content: (
            <>
              <p><strong>Transactions is one dated book of every dollar the season moved</strong> — newest at the top, with two amount columns (<strong>Money out</strong> and <strong>Money in</strong>) and a <strong>running balance</strong> beside each row. The last row&apos;s balance is your <strong>cash on hand</strong>, and every row above it is one of the movements that got you there.</p>
              ...
              <p>This tab has no Add button of its own — <strong>Record</strong> at the top of Money is the door, and pressed from here it opens already answered <em>we paid for something</em>. That form asks what the money paid for in one field: the <strong>bills you owe</strong> come first, your budget items underneath. Pick a bill and you are recording a payment against it; pick an item and you are recording a new cost. Either way it needs the day the money actually left — something you have agreed to pay but haven&apos;t is a schedule, and that is <strong>Add a commitment</strong> on Payables.</p>
              ...
              <HelpDefs>
                ...
                <HelpDef term="Leaving it blank">Records the cost as unpaid. It waits in the scheduled block above today, with a <strong>Record</strong> button that asks when the money went — and how much of it, if the team paid in pieces.</HelpDef>
                <HelpDef term="A date in the future">Refused — Record is for money that has already moved. The message links you straight to <strong>Payables</strong>, carrying your amount, item and description, because something you&apos;ve agreed to pay later is a schedule rather than a transaction.</HelpDef>
              </HelpDefs>
        ...
        },
        {
          ...
          content: (
            <>
              <p><strong>Payables is everything the team has agreed to pay but hasn&apos;t yet</strong> — one list of dated payments, money going <em>out</em> only. Player dues are money coming in and live on Player Dues, where the reminders that chase them are.</p>
              <p><strong>It opens as one line per bill</strong>, folded, so you can read the whole season at a glance. Each line carries the bill&apos;s <strong>next payment date</strong>, what is <strong>still owing</strong> with the total beneath it, how late or soon that payment is, and a <strong>Record</strong> button aimed at it. Open a bill to see the individual payments underneath; <strong>Fold all</strong> puts it back. Your folds last the visit, not forever.</p>
              <p><strong>Group by</strong> sits first and decides the arrangement, not what&apos;s shown — the same payments either way:</p>
              <HelpDefs>
                <HelpDef term="Commitment">Payments gather under the bill they belong to. The everyday view, and the one that answers <em>&ldquo;what do we owe, and on what?&rdquo;</em></HelpDef>
                <HelpDef term="Due date">The same payments in one dated run, under <strong>Overdue</strong> and month headings, each carrying that period&apos;s total. Answers <em>&ldquo;what is coming out, and when?&rdquo;</em> This one opens expanded, because a month heading on its own tells you nothing.</HelpDef>
              </HelpDefs>
        ...
        },
        {
          ...
          content: (
            <>
              ...
              <p><strong>Money you&apos;ve asked for isn&apos;t yours yet.</strong> A request awaiting an answer stays out of your cash on hand and out of your budget plan — but it does show on <strong>Transactions</strong> when <strong>Scheduled</strong> is on in its Status filter, at the foot of the list marked as undecided, so you can plan around it knowing the club may still say no.</p>
              ...
              <HelpNote variant="info" title="Your club, or an outside supplier?">The Club screen is always money moving between your team and your own club. Anything you owe someone outside it — a dome block, an umpire invoice, a tournament organizer — belongs on <strong>Payables</strong> instead.</HelpNote>
            </>
          ),
        },
        {
        ...
        },
        {
          ...
          content: (
            <>
              ...
              <p><strong>Those lists are always read-only</strong>, on purpose — the grid is a way of getting to your forms, never a second place to edit. Each one offers at most two doors: <strong>Transactions</strong>, the book of record, and the thing itself — that drive, that sponsor, Player Dues, Club. Some rows earn only one, and that&apos;s meaningful rather than missing: money back you typed in has no <em>thing</em> behind it, because the record <em>is</em> the thing.</p>
              <HelpDefs>
        ...
        },
        {
          ...
          content: (
            <>
              ...
              <p><strong>Tag your spending.</strong> Every expense and payable has an optional <strong>Tags</strong> box — your own labels like &ldquo;Winter dome&rdquo; or &ldquo;Spring tournament.&rdquo; Start typing to find one you&apos;ve used, or tap <strong>+ Create</strong>. Both <strong>Transactions</strong> and <strong>Payables</strong> have a <strong>Tags</strong> dropdown that narrows the list to one or several labels, and states what the narrowed list comes to. Because tags cut <em>across</em> categories, one label can span a facility rental and an officials fee — and the total is the answer to &ldquo;what did that weekend actually cost us?&rdquo; Change a row&apos;s tags by opening it (the pencil, or the row). Money tags are separate from game tags; <strong>Manage tags</strong> renames, merges or deletes yours. Tags <strong>shared by your whole organization</strong> show with a <strong>blue</strong> dot — you can apply them, but only an org admin changes them.</p>
            </>
          ),
        },
        {
      ...
      faqs: [
        ...
        },
        {
          ...
          answer: (
            <>
              <p>Yes — every Money page works on a phone. Lists of records (expenses, payables, allocation installments, fundraiser results) read as <strong>one card per item</strong> with a label on every line, so nothing runs off the edge.</p>
        ...
        },
        {
          ...
          answer: (
            <p>Yes. Every expense and payable has a <strong>Tags</strong> box — start typing to find a label you&apos;ve used or tap <strong>+ Create</strong> for a new one (like &ldquo;Winter dome&rdquo; or &ldquo;Tournament weekend&rdquo;). Only the tags you&apos;ve picked show as chips on the row. On <strong>Transactions</strong> and <strong>Payables</strong> a <strong>Tags</strong> dropdown narrows the list to one or several labels, and a line above the list states what the narrowed list comes to — &ldquo;$1,240.00 across 3 costs tagged Spring Classic&rdquo;, which is the whole point of tagging. You re-tag a row by opening it. <strong>Budget vs. Actual does not filter by tag</strong>, on purpose — a budget line carries no tag, so filtering there would set part of your spending against the whole of your plan and your headroom would go <em>up</em> as you narrowed. Tags answer &ldquo;what did this thing cost me?&rdquo; on Transactions; Budget vs. Actual answers &ldquo;how does the season compare to the plan?&rdquo; <strong>Fundraisers and sponsors carry the same tags</strong>, picked on the record itself rather than on the list, so one label can follow a thing in both directions — what it cost you and what it brought in — and both come through on the exports. Money tags are their own list (separate from game tags) and need <strong>money edit</strong> access to add or change. A club or league can also share tags org-wide — those appear in <strong>blue</strong> and you can apply them, but only an org admin edits them.</p>
          ),
          answerText: 'Yes. Every expense and payable has a Tags box — start typing to find a label you have used or tap + Create for a new one (like Winter dome or Tournament weekend). Only the tags you picked show as chips on the row. On Transactions and Payables a Tags dropdown narrows the list to one or several labels, and a line above the list states what the narrowed list comes to — $1,240.00 across 3 costs tagged Spring Classic — which is the whole point of tagging. Every row shows its own tags, and you change them by opening that record with the pencil or by tapping the row. The export follows the tag filter too. Budget vs. Actual does not filter by tag, on purpose — a budget line carries no tag, so filtering there would set part of your spending against the whole of your plan and your headroom would go up as you narrowed. Tags answer what did this thing cost me on Transactions; Budget vs. Actual answers how does the season compare to the plan. Fundraisers and sponsors carry the same tags, picked on the record itself rather than on the list, so one label can follow a thing in both directions — what it cost you and what it brought in — and both come through on the exports. Money tags are their own list, separate from game tags, and need money edit access to add or change. A club or league can also share tags org-wide — those appear in blue and you can apply them, but only an org admin edits them. Use Manage tags on Transactions to rename, merge, or delete your own money tags.',
