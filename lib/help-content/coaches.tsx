    ...
    },
    {
      ...
      subtopics: [
        ...
        },
        {
          ...
          content: (
            <>
              <p>Every tool is in the left sidebar — no turning anything on. It&apos;s <strong>grouped</strong> so related tools sit together:</p>
              <HelpDefs>
                <HelpDef term="Overview">At the top, on its own.</HelpDef>
                <HelpDef term="Squad">Roster, <strong>Attendance</strong> — your season attendance report, which also opens with a one-tap way to take attendance for your next game — and <strong>Lineups</strong>.</HelpDef>
                <HelpDef term="Season">Schedule and <strong>Insights</strong> — a season scoreboard, a &ldquo;What stands out&rdquo; list that flags what&apos;s worth your attention, and reports on results, playing time and attendance. This was called <em>Season Review</em>, and <em>History</em> before that.</HelpDef>
                ...
                <HelpDef term="Communication">Chat, Announcements.</HelpDef>
        ...
        },
        {
          ...
          content: (
            <>
              ...
              <p>Tools you aren&apos;t using yet stay out of the way: <strong>Tryouts</strong> and <strong>Tournaments</strong> wait under a small <strong>Explore</strong> heading and move up into Squad and Season automatically once your team runs a tryout or registers for a tournament.</p>
            </>
          ),
        },
        {
    ...
    },
    {
      ...
      subtopics: [
        ...
        },
        {
          ...
          title: 'Season settlement — paying families back',
          content: (
            <>
              <p>At the foot of <strong>Player Dues</strong>, <strong>Season settlement</strong> shows what the team owes each family and what&apos;s left to share out. Nothing to calculate and nothing to type — it reads your books, and it&apos;s true in October as well as in April.</p>

              <h4>Where the money comes from</h4>
              <p>The card adds up in front of you: dues received, plus fundraising raised, minus what you&apos;ve spent, gives <strong>the cash the team holds</strong>. Take off what you owe families, and what&apos;s left is <strong>the surplus to share</strong>. (A drive&apos;s full amount counts as money in, and each player&apos;s rebate sits on the <em>owed to families</em> line — so fundraising is counted once, in the right place.)</p>
              <p>The only figure you set is <strong>hold back</strong> — what you keep for next season. It can only come out of the surplus: you can&apos;t hold back money the team owes families, and the screen says so if you try.</p>
              ...
              <HelpDefs>
                ...
                <HelpDef term="Refund">The two together, minus anything they still owe. A family who ends up <strong>Still owes</strong> is shown as owing, never as a payout.</HelpDef>
              </HelpDefs>
              <p><strong>Tap any row</strong> and it opens to show exactly where its number came from. Families with more than one player are grouped, so you write one cheque.</p>

              <h4>Paying it out</h4>
              <HelpSteps>
                <li><strong>Pay out</strong> on a row (or on a family) opens the same sheet you use anywhere else, filled in with what they&apos;re owed. <strong>Pay all</strong> records the lot in one pass.</li>
                <li>A paid row shows the date the money went out and stops asking. Paying one family never changes anyone else&apos;s share.</li>
                <li><strong>Change</strong> on a row sets what that family takes: an even share, a set amount, no share at all, or <strong>forgive</strong> what they still owe. Whatever a choice frees up goes to the other families straight away.</li>
              </HelpSteps>
              <HelpNote variant="warning" title="When the sums are ahead of the bank">If a family still owes, their debt counts as money coming in and lifts everyone&apos;s share — so the cheques can add up to more than the team is holding until they pay. The sheet says so, and names whose money the others are waiting on. And if the team can&apos;t cover what it owes families at all, it says that plainly and shares nothing rather than quietly shrinking anyone&apos;s rebate.</HelpNote>
            </>
          ),
        },
        {
      ...
      faqs: [
        ...
        },
        {
          ...
          answer: (
            <>
              <p>Open <strong>Season settlement</strong> at the foot of <strong>Player Dues</strong>. It works the money out for you and shows you the arithmetic: dues received plus fundraising raised minus what you spent is <strong>the cash the team holds</strong>; take off what you owe families, and what&apos;s left is <strong>the surplus to share</strong>.</p>
              <p>Each family&apos;s row is their own money back plus one even share, less anything they still owe. <strong>Tap a row</strong> to see where its number came from, and <strong>Pay out</strong> to record the cash — one row, one family, or <strong>Pay all</strong> at once. Siblings are grouped, so you write one cheque.</p>
              <p><strong>Change</strong> on a row sets what that family takes: an even share, a set amount, no share, or <strong>forgive</strong> what they still owe. Whatever a choice frees up goes to the other families straight away, so the rows always add back up to the pot.</p>
              <p>Two things it will tell you rather than hide: if a family still owes, their share is partly money that hasn&apos;t arrived yet, and the sheet names who the others are waiting on. And if the team can&apos;t cover what it owes families, it says so and shares nothing rather than quietly shrinking anybody&apos;s rebate.</p>
              <p>It&apos;s honest all year, not just in April — in October it simply shows what the team is holding, with no shares to give out yet.</p>
            </>
          ),
          answerText: 'Open Season settlement at the foot of Player Dues. It works the money out for you and shows the arithmetic: dues received plus fundraising raised minus what you spent is the cash the team holds; take off what you owe families and what is left is the surplus to share. There is no total to type and no Calculate button — the old Season Refund Calculator is gone, along with the double-counting it allowed. Each family row is their own money back plus one even share, less anything they still owe. Tap a row to see where its number came from, and Pay out to record the cash — one row, one family, or Pay all at once. Siblings are grouped so you write one cheque. Change on a row sets what that family takes: an even share, a set amount, no share, or forgive what they still owe; whatever a choice frees up goes to the other families straight away so the rows always add back up to the pot. Hold back keeps money for next season and can only come out of the surplus — never out of what the team owes families. If a family still owes, their share is partly money that has not arrived yet and the sheet names who the others are waiting on. If the team cannot cover what it owes families it says so and shares nothing rather than shrinking anyone’s rebate. It is honest all year, not just in April.',
          keywords: ['season settlement', 'settlement sheet', 'season refund', 'refund calculator', 'where is the refund calculator', 'refund the families', 'give the money back', 'pay the families back', 'money left over', 'whats left at the end of the season', 'surplus', 'surplus to share', 'even share', 'hold back', 'keep money for next season', 'forgive a balance', 'set a refund amount', 'no share', 'still owes', 'pay all', 'one cheque per family', 'siblings', 'end of season money', 'closing the books'],
        },
        {
