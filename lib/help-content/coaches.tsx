        ...
        },
        {
          ...
          content: (
            <>
              ...
              <HelpDefs>
                <HelpDef term="Budget">Your <strong>plan</strong> — the dues installments you set and your expected fundraising and sponsorship on one side, the months you gave your costs on the other. It shows whether the plan itself runs short, months before the money does.</HelpDef>
