  ...
  sections: [
    {
      ...
      faqs: [
        ...
        },
        {
          ...
          answerText: 'The free portal now uses the same navigation as the rest of the FieldLogicHQ app. Your team sections (Overview, Tournaments, any tools you have turned on, and Explore) are a row of tabs under your team name — a list on the left on a computer. The old More menu is gone: sign out, appearance, feedback, and this help guide now live on the Account tab in the app bar at the bottom of your phone; team chat lives on the Chat tab. Tapping Chat from your portal shows a "Back to your Coaches Portal" link at the top of the chat screen, so you can get straight back to where you were. If you have more than one team, tap your team name in the header to switch.',
          keywords: ['menu gone', 'more menu', 'where is sign out', 'sign out', 'log out', 'feedback', 'account tab', 'switch team', 'navigation changed', 'new layout', 'back to portal', 'get back from chat', 'lost in chat'],
          answer: (
            <>
    ...
    },
    {
      ...
      summary: 'Run the whole tryout from your phone: sessions, scorecard, check-in, scoring it yourself (plus helpers if you like), a live ranked scoreboard, Offer/Waitlist decisions with family emails you switch on only if you want them, and one-tap accept onto your roster with fees — kept fair with blind evaluation.',
      keywords: ['tryouts', 'tryout day', 'check-in', 'bib numbers', 'blind evaluation', 'walk-up', 'scorecard', 'evaluators', 'scoreboard', 'ranking', 'decision board', 'offer', 'waitlist', 'reveal names', 'lock scoring', 'accept', 'add to roster', 'fees', 'dues', 'score players', 'score yourself', 'email families', 'family emails', 'email this offer', 'new link'],
      searchText: 'tryouts tryout day sessions dates times location field check in check-in bib number auto assign blind evaluation names hidden anonymous walk up walk-up add candidate print roster sheet paper backup provincial window OBA softball ontario schedule marker premium run tryouts evaluate players scorecard rubric categories skills weight rating scale 1-5 1-10 hitting fielding throwing speed attitude evaluators assistant helper no login link score scoring rate players score players myself score as yourself signed in live scoreboard ranked ranking composite weighted average bias runs hot runs cold consensus lock scoring freeze reopen reveal names unblind one-way decision board offer waitlist not this season cut pass pick selections roster accept add to roster onboard finalize fees dues standard fee schedule installments prefilled optional no card charge email families my decisions switch off by default record only reach out yourself email this offer resend new link fresh link expired lost link scores kept no email on file notify by phone didn’t check in family’s note',
      content: (
        <>
        ...
        },
        {
          ...
          answer: (
            <>
              ...
              <p>The <strong>Development report in Insights</strong> (&ldquo;Is everyone getting attention?&rdquo;) shows a <strong>History linked</strong> column, so you can see at a glance whose past seasons are connected.</p>
            </>
          ),
        },
        {
    ...
    },
    {
      ...
      summary: 'Where everything lives on Premium: the sidebar sections, the notification bell, the one card at the top of your Overview, and your six at-a-glance tiles.',
