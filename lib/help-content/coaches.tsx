...
const coachesHelp: HelpPageContent = {
  ...
  sections: [
    ...
    },
    {
      ...
      keywords: ['money', 'money hub', 'budget', 'season budget', 'dues', 'expenses', 'money in', 'money out', 'on hand', 'headroom', 'budget headroom', 'season total', 'non-itemized buffer', 'generate installments', 'split evenly', 'percent split', 'custom category', 'budget categories', 'unbudgeted', 'recategorize', 'export budget', 'treasurer'],
      ...
      content: (
        <>
          ...
          <p>Assistant coaches need <strong>money access</strong> from the head coach: with read access they see every number but no action buttons; with it off, Money doesn&apos;t appear for them at all.</p>
        </>
      ),
      faqs: [
        {
        ...
        },
        {
          ...
          answer: (
            <>
              ...
              <p><strong>Every figure comes only from saved lineups</strong> — records count only games with a score entered, and nothing is invented. Haven&apos;t saved lineups yet? You&apos;ll see an honest empty state rather than made-up numbers. (These read-outs used to sit at the bottom of the <strong>Lineups</strong> page — they moved to Insights so all your season read-outs live in one place; the Lineups <strong>Games</strong> tab keeps a quiet <strong>Season insights</strong> link that jumps there.)</p>
            </>
          ),
        },
      ],
