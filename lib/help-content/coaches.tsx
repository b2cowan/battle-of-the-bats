...
const coachesHelp: HelpPageContent = {
  ...
  sections: [
    ...
    },
    {
      ...
      content: (
        <>
          <p>You run the same warm-up most Tuesdays. <strong>Drills</strong> is where you write it down once — and after that, putting it in a practice is a few taps instead of retyping it. You&rsquo;ll find it in <strong>Skills &amp; Goals → Drills</strong> (it was called Your drills before September 2026).</p>
        </>
      ),
      subtopics: [
        {
