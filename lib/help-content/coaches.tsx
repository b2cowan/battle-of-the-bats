        ...
        },
        {
          ...
          content: (
            <>
              ...
              <p><strong>Every figure on a row opens what&apos;s behind it.</strong> Tap the <strong>budget</strong> figure to see the plan lines summed into that row, with their amounts and notes &mdash; open one to edit it. Tap the <strong>actual</strong> figure to see every payment counted against the row, on the day it happened and whoever paid it, with any <strong>money back</strong> listed underneath and netted off. Tap the row itself to open its payment schedule. <strong>Player dues is the one row that doesn&rsquo;t open</strong>, because there is nothing of this report&rsquo;s kind behind it &mdash; dues are a schedule, not budget lines, and the payments live on Player Dues. Its caption points you there.</p>
