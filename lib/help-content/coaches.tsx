    ...
    },
    {
        ...
        },
        {
          ...
          content: (
            <>
              ...
              <p><strong>The filter strip is four small dropdowns</strong> — <strong>Show</strong>, <strong>Status</strong>, <strong>Item</strong>, <strong>Date</strong> — and the book narrows to whatever they say. <strong>Show</strong> picks kinds of money (Expenses · Income · Refunds · from Dues · from Fundraising · from Club — tick more than one at once), <strong>Item</strong> narrows to one or several of your budget words, and your money tags sit beside them. <strong>The Balance column disappears whenever you narrow by kind, item or tag</strong> — a running total over some of the rows would look like your cash and wouldn&apos;t be it. Narrowing by <em>date</em> keeps the column: those rows are still the one timeline, just less of it.</p>
          ...
          content: (
            <>
              ...
              <HelpDefs>
                ...
                <HelpDef term="Actual">Real <strong>cash</strong> — every dollar that arrived and every dollar that left, in the month it moved.</HelpDef>
              ...
              <p><strong>Tapping a figure takes you to the tool that owns it:</strong> a budget cell opens that line&apos;s form with its payment dates ready to edit; an Actual or Scheduled expense figure opens a plain list of what makes it up. The grid is a way of getting to your forms, never a second place to edit.</p>
            </>
          ),
        },
        {
        ...
        },
        {
          ...
          content: (
            <>
              ...
              <p><strong>Tag your spending.</strong> Every expense and payable has an optional <strong>Tags</strong> box — your own labels like &ldquo;Winter dome&rdquo; or &ldquo;Spring tournament.&rdquo; Start typing to find one you&apos;ve used, or tap <strong>+ Create</strong>. <strong>Transactions</strong> filters by tag, and because tags cut <em>across</em> categories one label can span a facility rental and an officials fee. Change a row&apos;s tags by opening it (the pencil, or the row). Money tags are separate from game tags; <strong>Manage tags</strong> on Transactions renames, merges or deletes yours. Tags <strong>shared by your whole organization</strong> show in <strong>blue</strong> — you can apply them, but only an org admin changes them.</p>
            </>
          ),
        },
        {
      ...
      faqs: [
        ...
        },
        {
          ...
          answer: (
            <p>Yes. Every expense and payable has a <strong>Tags</strong> box — start typing to find a label you&apos;ve used or tap <strong>+ Create</strong> for a new one (like &ldquo;Winter dome&rdquo; or &ldquo;Tournament weekend&rdquo;). Only the tags you&apos;ve picked show as chips. On <strong>Transactions</strong>, the tag chips narrow the book to one label, and you re-tag a row by opening it. <strong>Budget vs. Actual does not filter by tag</strong>, on purpose — a budget line carries no tag, so filtering there would set part of your spending against the whole of your plan and your headroom would go <em>up</em> as you narrowed. Tags answer &ldquo;what did this thing cost me?&rdquo; on Transactions; Budget vs. Actual answers &ldquo;how does the season compare to the plan?&rdquo; <strong>Fundraisers and sponsors carry the same tags</strong>, picked on the record itself rather than on the list, so one label can follow a thing in both directions — what it cost you and what it brought in — and both come through on the exports. Money tags are their own list (separate from game tags) and need <strong>money edit</strong> access to add or change. A club or league can also share tags org-wide — those appear in <strong>blue</strong> and you can apply them, but only an org admin edits them.</p>
          ),
          answerText: 'Yes. Every expense and payable has a Tags box — start typing to find a label you have used or tap + Create for a new one (like Winter dome or Tournament weekend). Only the tags you picked show as chips. On Transactions, the tag chips narrow the book to one label, every row shows its own tags, and you change them by opening that record with the pencil or by tapping the row. Tags come through on the export too. Budget vs. Actual does not filter by tag, on purpose — a budget line carries no tag, so filtering there would set part of your spending against the whole of your plan and your headroom would go up as you narrowed. Tags answer what did this thing cost me on Transactions; Budget vs. Actual answers how does the season compare to the plan. Fundraisers and sponsors carry the same tags, picked on the record itself rather than on the list, so one label can follow a thing in both directions — what it cost you and what it brought in — and both come through on the exports. Money tags are their own list, separate from game tags, and need money edit access to add or change. A club or league can also share tags org-wide — those appear in blue and you can apply them, but only an org admin edits them. Use Manage tags on Transactions to rename, merge, or delete your own money tags.',
