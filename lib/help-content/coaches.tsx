        ...
        },
        {
          ...
          content: (
            <>
              ...
              <HelpDefs>
                <HelpDef term="Coverage">One row per player, roster order — a checklist, never a ranking. <strong>Show</strong> picks what the row says: <em>Current focus</em> (the goals being worked on, in words — with Internal notes) or one metric, whose column answers with <em>its</em> latest result or observation and <em>its</em> date — <em>8.31 seconds (of 2)</em>, <em>2 of 3 in range</em>, a skill&rsquo;s descriptor, <em>Not assessed</em> dated by the session that marked it. The count line comes first — <em>4 of 12 players have a 60-yd sprint result this season · roster order, not a ranking</em> — it counts records, never attention. A dash is an absence; the legend under the table says so. <strong>Progress →</strong> on a metric row opens that player in the next report with the metric kept; the name opens their record. <strong>Record in Skills &amp; Goals →</strong> sits under the table for coaches who hold the Development switch. On a phone each player is one line — the name, <em>8.28 seconds · 15 Sept · ✓</em>, and a chevron that is the Progress door.</HelpDef>
