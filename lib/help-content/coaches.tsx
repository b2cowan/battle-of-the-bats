    ...
    },
    {
      ...
      faqs: [
        ...
        },
        {
          ...
          answer: (
            <p>Yes. Every expense and payable has a <strong>Tags</strong> box — start typing to find a label you&apos;ve used or tap <strong>+ Create</strong> for a new one (like &ldquo;Winter dome&rdquo; or &ldquo;Tournament weekend&rdquo;). Only the tags you&apos;ve picked show as chips. On <strong>Transactions</strong>, the tag chips narrow the book to one label, and you re-tag a row by opening it. <strong>Budget vs. Actual</strong> gets the same filter — choose a tag to see just that spending, totalled across every category it touches. <strong>Fundraisers and sponsors carry the same tags</strong>, picked on the record itself rather than on the list, so one label can follow a thing in both directions — what it cost you and what it brought in — and both come through on the exports. Money tags are their own list (separate from game tags) and need <strong>money edit</strong> access to add or change. A club or league can also share tags org-wide — those appear in <strong>blue</strong> and you can apply them, but only an org admin edits them.</p>
          ),
          answerText: 'Yes. Every expense and payable has a Tags box — start typing to find a label you have used or tap + Create for a new one (like Winter dome or Tournament weekend). Only the tags you picked show as chips. On Transactions, the tag chips narrow the book to one label, every row shows its own tags, and you change them by opening that record with the pencil or by tapping the row. Tags come through on the export too. Budget vs. Actual gets the same filter — choose a tag to see just that spending, totalled across every category it touches. Fundraisers and sponsors carry the same tags, picked on the record itself rather than on the list, so one label can follow a thing in both directions — what it cost you and what it brought in — and both come through on the exports. Money tags are their own list, separate from game tags, and need money edit access to add or change. A club or league can also share tags org-wide — those appear in blue and you can apply them, but only an org admin edits them. Use Manage tags on Transactions to rename, merge, or delete your own money tags.',
