  ...
  sections: [
    {
      ...
      keywords: ['coaches portal', 'free', 'team home', 'what is', 'overview', 'coach', 'your tournaments', 'tournament history', 'team tools', 'schedule tile', 'next game', 'fan view', 'tabs', 'navigation', 'bottom bar'],
      searchText: 'coaches portal free team home tournament participant year round roster schedule fees announcements premium upgrade what is overview page order your tournaments tournament history renamed your event card team tools beyond this tournament divider at a glance stat strip schedule tile next game live tournament game live score fan view public site flip public schedule tabs tab row navigation getting around bottom bar home scores chat account team header where is the menu back to your coaches portal return from chat',
      content: (
        <>
          ...
          <p><strong>What&apos;s on your Overview, top to bottom:</strong> <strong>Your tournaments</strong> comes first — every event you&apos;ve entered, since that&apos;s usually why you&apos;re here — followed by <strong>Your event</strong> while a tournament is live or coming up. Below those sits a divider, <em>&ldquo;Your team — beyond this tournament&rdquo;</em>, and everything under it belongs to your team rather than to any one event: <strong>At a glance</strong> (roster size, unpaid fees, how many parents you can reach, your next practice or game) and the free team tools. Nothing below that divider is homework an organizer is waiting on — it&apos;s yours to use whenever you like, and it carries over to every event you enter.</p>
