        ...
        },
        {
          ...
          content: (
            <>
              ...
              <p><strong>The page holds still between visits.</strong> In the List, a quiet <strong>Schedule</strong> column shows each line&apos;s phasing at a glance — <em>Jan–Mar · 3 chunks</em>, a single month, or a dash for a lump sum — and <strong>Collapse all / Expand all</strong> beside the View pill folds the whole outline in one tap — on the List or By period, whichever you are reading. The same control sits on <strong>Budget vs. Actual</strong>, which opens with every category folded. Which view you read, which columns, and which categories you left open are all remembered for that team and season, so tomorrow opens where today left off.</p>
        ...
        },
        {
          ...
          content: (
            <>
              ...
              <p><strong>By activity now downloads as itself.</strong> You get a block per category with its own revenue and costs and a <strong>netted</strong> line — the shape that answers &ldquo;did the tournament pay for itself?&rdquo; Previously it quietly handed you the Statement instead.</p>
            </>
          ),
        },
        {
