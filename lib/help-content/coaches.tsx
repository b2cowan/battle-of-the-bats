          ...
          content: (
            <>
              ...
              <HelpDefs>
                ...
                <HelpDef term="A sponsor came through">Asks <strong>Which sponsor?</strong> — your pledges first, or <em>a new sponsor</em>, which records them right there: name, amount, the day it arrived, and which families to credit ($ or %, prefilled with your team&apos;s standard share). It lands on Fundraising exactly as if created there. A <em>promised</em> sponsorship is a pledge: pick <strong>This is a promise — nothing arrived yet</strong> in the same list and the pledge sheet opens on Fundraising with your typing carried.</HelpDef>
        ...
        },
        {
          ...
          content: (
            <>
              ...
              <p><strong>＋ Pledge</strong> logs the promise: the sponsor&apos;s name, the pledged amount, an optional <strong>Expected by</strong> date, and which families to credit. Saving it moves no money — the sheet says so — it joins your plan and your forward view, and you record each cheque as it arrives. If the cheque is already in hand, the sheet&apos;s own <strong>Record it instead</strong> link switches you over with your typing carried. Once the expected date passes with money still to come, the row quietly says <strong>past its expected date</strong>.</p>
              <p>When a cheque arrives, press <strong>Record</strong> — in the sponsor&apos;s room, or anywhere in Money — and answer <em>a sponsor came through</em>. The form asks <strong>Which sponsor?</strong>, listing your pledges first with what each still owes; picking one records the arrival against its promise. A sponsor you never logged as a pledge is one more answer in the same list — <em>a new sponsor</em> — which creates them with their first cheque in one save. And if you get that far and realise nothing has actually arrived, the same list has <strong>This is a promise — nothing arrived yet</strong>: pick it and the pledge sheet opens on Fundraising with the name and amount you typed carried across, headed with the answer you just gave so the change of screen is never a surprise. There is no sponsor list to pick from there, because a promise always starts a new sponsorship — the sponsor and the pledge are one record. There is no Received-or-Pledged question anywhere: <strong>the numbers answer it</strong> — money in the In column means received, money in To come means still promised — and the chip on the row is worked out from them.</p>
