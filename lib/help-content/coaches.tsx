          ...
          content: (
            <>
              ...
              <HelpDefs>
                ...
                <HelpDef term="Planned funding">A budget line is an <strong>expense</strong> or <strong>money coming in</strong>, and money in reports under the <strong>category you filed it in</strong>, exactly as a cost does — <strong>Fundraising</strong> (a drive — something the team sells), <strong>Sponsorship</strong> (a sponsor or a grant, given directly), <strong>Tournaments</strong>, <strong>Other Income</strong> (interest, a facility rebate, a plain donation), or a category of your own. A Fundraising or Sponsorship word is filled in from the Fundraising screen; everything else you record yourself, the way you record an expense. All of it is subtracted from what the season costs, so the plan tells you what players actually have to fund and dues are generated from that: budget $4,000 of funding against an $8,000 season and per player drops from $800 to $400. For fundraising, enter what you expect the <strong>team</strong> to keep — if a campaign pays part of what a player raises back to that player, it already lowers their own dues and shouldn&apos;t be counted twice.</HelpDef>
                <HelpDef term="Player installments">The season&apos;s story: before dues exist it&apos;s <strong>estimated</strong> for you (costs less fundraising, with the per-player figure beside it and Set dues for all players one tap away); the moment dues go out it becomes the <strong>official scheduled figure</strong>.</HelpDef>
              </HelpDefs>
              ...
              <p><strong>The plan adds up on the page, not just on the card.</strong> Your lines sit in two bands — <strong>Costs</strong> and <strong>Funding</strong> — and each band closes with a subtotal wearing the same name as the figure above it: <strong>Planned costs</strong> and <strong>Planned funding</strong>. Under them the plan finishes its arithmetic in the open — <strong>Costs less funding</strong>, then <strong>Player installments</strong>, marked <em>estimated</em> until dues go out, and it closes on <strong>Short of covering the plan</strong> — the one line drawn in amber, because it is the only state on the page that asks you to do something — or <strong>Planned buffer</strong>, which stays in ordinary ink because it is a confirmation, not a warning. Two things rename themselves rather than quietly meaning something else: with an <strong>Estimated total</strong> set, the costs subtotal reads <strong>Lines so far</strong>, because the estimate is the plan&apos;s total and those are the lines you have itemised toward it; and with the <strong>When</strong> filter narrowing the list, the two subtotals read <strong>Costs shown</strong> and <strong>Funding shown</strong>, because they now describe a slice rather than the season. One name, one number — so no figure on this page can be read as answering a question it isn&apos;t.</p>
        ...
        },
        {
          ...
          content: (
            <>
              ...
              <p><strong>The period view closes the same way the List does.</strong> Under the two band subtotals it finishes on <strong>Costs less funding</strong>, then <strong>Player installments</strong> &mdash; your dues schedule, spread across the periods it falls due in &mdash; then <strong>Shortfall (Buffer)</strong>. Read that last row either way: a plain figure is what that period still needs, and a figure <strong>in brackets</strong> is that period covered with room to spare, because the money lands ahead of the bills and goes toward the rest of the season. Its <strong>Total</strong> is the same buffer or shortfall the List closes on. Before you have set dues those two rows stay away, and a line under the table offers <strong>Set dues for all players</strong> instead; and if you have set a <strong>season estimate</strong>, the part you haven&rsquo;t itemized yet shows as its own row under <strong>No date yet</strong> &mdash; an estimate has no dates &mdash; so <strong>Planned costs</strong> here is the same figure the List calls Planned costs.</p>
              <p><strong>A figure in brackets is a negative</strong>, on this grid and on Budget vs. Actual&rsquo;s months &mdash; and what it means depends on the row it is in. On the plan it is money arriving ahead of the bills, which is good news. On Budget vs. Actual&rsquo;s <strong>Net for the month</strong> and <strong>Closing balance</strong> rows it is the opposite &mdash; the account below zero, and the one figure on that screen worth stopping for. Where a row&rsquo;s own wording already says which way the money went, there is no sign to read: <strong>Planned buffer</strong> and <strong>Over your estimate</strong> say it in words, so their figures stay plain.</p>
