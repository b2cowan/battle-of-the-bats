      ...
      subtopics: [
        {
          ...
          title: 'How the page is laid out — three views, and starting from scratch',
          content: (
            <>
              <p>Skills &amp; Goals is three views across the top, and one lime <strong>+ Start session</strong> button in the page header:</p>
              <HelpDefs>
                <HelpDef term="Sessions">Where you land. Every evaluation session as a row — its date and note — with a search box, and the quiet links out: the coverage report in <strong>Insights</strong>, <strong>Drills</strong> and <strong>Plan templates</strong>.</HelpDef>
        ...
        },
        {
          ...
          content: (
            <>
              <p>Every coach with a team duty can read Skills &amp; Goals; goals, observations and reviews show only with Internal notes. <strong>Writing</strong> follows one switch on the staff sheet: <strong>Development</strong> — <em>&ldquo;Define tests, run sessions and record results. With Internal notes, write goals too.&rdquo;</em></p>
              <HelpDefs>
                <HelpDef term="Head coach">Always has it.</HelpDef>
                <HelpDef term="Assistant with it on">Defines and retires metrics, starts sessions, records results and attempts, marks a player not assessed — and, if they also hold Internal notes, adds and reviews goals and records observations (a coach&rsquo;s written judgement about a child rides the same gate goals do).</HelpDef>
                <HelpDef term="Assistant with it off">The default for every new assistant and every role. Reads the same screens; anything they try to change answers <em>You don&rsquo;t have the Development grant on this team. Ask the head coach to turn it on.</em></HelpDef>
              </HelpDefs>
      ...
      faqs: [
        {
          ...
          answer: (
            <>
              ...
              <p>When that&rsquo;s the case, the Sessions view says so and points you to <strong>Metrics</strong> — define a test there and <strong>Start session</strong> turns on straight away.</p>
              ...
              <p>If you&rsquo;re an <strong>assistant coach</strong>, the button appears only when the head coach has turned on the <strong>Development</strong> switch for you; without it, the page is read-only.</p>
            </>
          ),
        },
        {
