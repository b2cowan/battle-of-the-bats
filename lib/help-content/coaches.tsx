      ...
      subtopics: [
        {
          ...
          content: (
            <>
              <p>A <strong>bar across the top</strong> of every team page tells you where you are and how the season is going. On the <strong>left</strong>: your <strong>team</strong>, with a quieter line underneath carrying your club&rsquo;s name, the season <strong>year</strong> and your <strong>record</strong> (a standalone team has no club, so that part is simply absent). On the <strong>right</strong>: the one thing that matters today — a <strong>Game day</strong> badge with the opponent and time, or <strong>Next</strong> with your next practice or game. A quiet week shows just the year and the record; nothing is invented to fill the space.</p>
              <p>Open a finished season and the right side reads <strong>Complete</strong> with that season&rsquo;s <strong>final record</strong> instead. It&rsquo;s a read-out, not a menu — your screens always show the season your team is on. <strong>⇄ Public site</strong> sits at the far right and flips to your club&rsquo;s public pages (a standalone team has no public site, so it doesn&rsquo;t show). As you scroll, the bar slims to one line so the page gets the room: on a computer it keeps your team name and today&rsquo;s status, and on a phone it keeps your team name alone. Scroll back to the top and it returns in full.</p>
    ...
    },
    {
      ...
      subtopics: [
        ...
        },
        {
          ...
          content: (
            <>
              <p>A green <strong>+ Record</strong> button sits at the end of the Money tab row — on <strong>every</strong> tab, on a phone as much as a desktop — so logging something never means finding the right screen first. Press it and answer one question, <strong>&ldquo;What happened?&rdquo;</strong>, and it files the money exactly where its home tab would.</p>
              <HelpDefs>
                <HelpDef term="A family paid their dues">Lands on that child&apos;s bill, same as recording it from Player Dues.</HelpDef>
                ...
                <HelpDef term="A sponsor came through">Opens the Fundraising tab&apos;s own sponsor form, already set to <em>sponsor</em> — this one hands off rather than saving on the spot.</HelpDef>
                ...
                <HelpDef term="We settled up with the club">Marks an owed installment paid, same as <strong>Mark paid</strong> on the Club tab. Only offered when your team belongs to a club or league.</HelpDef>
              ...
              <p><strong>&ldquo;We paid for something&rdquo; asks one more question, right there in the form:</strong> <strong>Has it been paid?</strong> Answer <em>Paid</em> for one amount on one date and it lands on Transactions; answer <em>Not yet — we owe it</em> to open the schedule editor and it lands on Payables instead. You no longer choose between the two tabs to answer that — the question does it for you.</p>
              <HelpNote variant="tip" title="Nothing old went away">Every per-tab door still works exactly as before — Transactions&apos; <strong>Add</strong>, Payables&apos; <strong>Add a commitment</strong>, Player Dues&apos; <strong>Record payment</strong> and <strong>Record as paid</strong>, a fundraiser&apos;s <strong>Log amount</strong>, Club&apos;s <strong>Mark paid</strong>. <strong>Record</strong> is one more way in, not a replacement — pick whichever is faster for what you&apos;re doing.</HelpNote>
        ...
        },
        {
          ...
          content: (
            <>
              ...
              <p><strong>Add</strong> opens the same <strong>&ldquo;What happened?&rdquo;</strong> form the hub&apos;s <strong>Record</strong> button uses, already answered for the tab you&apos;re on — change it right there if you picked the wrong one, and everything you&apos;ve typed comes with you. On <strong>We paid for something</strong>, a question inside the form — <strong>Has it been paid?</strong> — decides Transactions or Payables for you: <em>Paid</em> is one amount on one date here; <em>Not yet — we owe it</em> opens the schedule editor and the record lands one tab over, on <strong>Payables</strong>, instead.</p>
              ...
              <HelpDefs>
                ...
                <HelpDef term="Leaving it blank">Records the cost as unpaid. It waits in the scheduled block above today, with a <strong>Record a payment</strong> button that asks when the money went — and how much of it, if the team paid in pieces.</HelpDef>
        ...
        },
        {
          ...
          content: (
            <>
              ...
              <HelpDefs>
                <HelpDef term="What the club has billed us">Your club&apos;s owner or treasurer splits a shared cost — field and diamond fees, league insurance, association dues — across its teams, and your share arrives here already divided into instalments with due dates. You can&apos;t create or change one: your job is to <strong>file it</strong> under one of your own budget words and <strong>mark each instalment paid</strong> as you pay it. Instalments coming due also show on <strong>Payables</strong>, marked <em>From your club</em>, and in <strong>Next 30 days</strong>.</HelpDef>
        ...
        },
        {
          ...
          content: (
            <>
              ...
              <HelpDefs>
                <HelpDef term="Budget">What you <strong>planned</strong> for that month.</HelpDef>
                <HelpDef term="Scheduled">What you <strong>still owe</strong>, by the date it&apos;s due — including anything already past due. A bill you&apos;ve settled leaves this view entirely (it&apos;s <em>Actual</em> now), and a part-paid one shows only the remainder, so the row falls as the season is paid down. The same figure the Payables list and <em>Next 30 days</em> quote, so all three agree.</HelpDef>
                <HelpDef term="Actual">What&apos;s been <strong>paid</strong>.</HelpDef>
              ...
              <p><strong>Will we run short?</strong> Under the month grid, three rows answer it: <strong>money in</strong>, <strong>money out</strong>, and a <strong>running balance</strong>. If the balance dips below zero, a line underneath names the month and the amount in plain words. It projects using whichever view you&apos;re reading and says so, so it&apos;s always clear which one you&apos;re looking at: Budget projects your plan, Scheduled projects what you still owe, and on both of those money in is your dues installments — the only income with a schedule. On <strong>Actual</strong>, the strip is your real cash story: money in is every dollar that arrived (dues, fundraising and sponsor money, income and money back you recorded, anything the club sent), money out is every dollar that left (bills paid, money paid back to families, payments to the club), each in the month it moved — so the running balance ends on the same number as Cash on hand. A cost a family paid a vendor directly stays out of the cash rows: your season spent it, but no team money moved. This report covers <strong>this season only</strong>, and there is no last-season column: a bare year sitting among the months read as another month of this season, and comparing two seasons is a different question from tracking this one.</p>
      ...
      faqs: [
        ...
        },
        {
          ...
          popular: true,
          answer: (
            <p><strong>+ Record</strong> sits at the end of the tab row on every Money screen — desktop and phone — so you can write down money that moved without hunting for the right tab first. Press it and answer one question, <strong>&ldquo;What happened?&rdquo;</strong>, from eight plain-language choices (dues paid, fundraiser money, a sponsor, money back on a cost, other money in; paying for something, settling up with the club, paying a family back), and it lands the record exactly where its home tab would — the child&apos;s bill on Player Dues, the drive&apos;s leaderboard, the club installment marked paid, and so on. It doesn&apos;t replace anything: Transactions&apos; <strong>Add</strong>, Payables&apos; <strong>Add a commitment</strong>, Player Dues&apos; <strong>Record payment</strong>, a fundraiser&apos;s <strong>Log amount</strong> and Club&apos;s <strong>Mark paid</strong> all still work exactly as before. It&apos;s an extra door in, for whichever moment you happen to be in when the money moves.</p>
          ),
          answerText: '+ Record sits at the end of the tab row on every Money screen — desktop and phone — so you can write down money that moved without hunting for the right tab first. Press it and answer one question, "What happened?", from eight plain-language choices (dues paid, fundraiser money, a sponsor, money back on a cost, other money in; paying for something, settling up with the club, paying a family back), and it lands the record exactly where its home tab would — the child\'s bill on Player Dues, the drive\'s leaderboard, the club installment marked paid, and so on. It does not replace anything: Transactions\' Add, Payables\' Add a commitment, Player Dues\' Record payment, a fundraiser\'s Log amount and Club\'s Mark paid all still work exactly as before. It is an extra door in, for whichever moment you happen to be in when the money moves.',
