        ...
        },
        {
          ...
          content: (
            <>
              ...
              <p><strong>The banner above the report gives three answers in one row</strong>: Headroom (the number this page exists for), how much of the spending was <strong>off-plan</strong> when any was, and a forward sentence — <em>&ldquo;on what&apos;s scheduled you end the season with $X&rdquo;</em> — whose figure opens Months · Scheduled, the reading it comes from. Pledges and pending club asks ride it as a separate <em>&ldquo;plus $Y possible&rdquo;</em>, never banked into the headline.</p>
