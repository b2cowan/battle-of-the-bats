          ...
          content: (
            <>
              ...
              <HelpDefs>
                ...
                <HelpDef term="Also save its written stations as drills">Ticked, each station you wrote yourself (not one that already came from a drill) is saved to your drills first, with the same tags, and the circuit&rsquo;s stations point at them — so the next time the circuit lands, those stations are drills and count as drills. Unticked, the circuit keeps the words as plain stations.</HelpDef>
              </HelpDefs>
