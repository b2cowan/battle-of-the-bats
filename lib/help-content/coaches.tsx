      ...
      faqs: [
        {
          ...
          answer: (
            <>
              ...
              <p><strong>Pitchers are set separately</strong> in a <strong>Pitching</strong> section — turn on <strong>&ldquo;This player pitches&rdquo;</strong> and set their <strong>rank</strong> (Ace, #2, #3…) and an optional <strong>max innings per game</strong> arm-care cap. Pitching is handled here, not as one of the fielding chips.</p>
    ...
    },
    {
      ...
      faqs: [
        ...
        },
        {
          ...
          answerText: 'Auto-fill uses the positions you set on each player’s profile. It never puts a player at a position you marked Never, and it favors each player’s Best positions in the order you ranked them (Okay spots are used as fill-ins). For the mound, it uses your pitchers: competitive games lead with your ace, balanced and development games spread innings down the pitcher order, and it never works a pitcher past their max-innings cap. It still shares playing time fairly and avoids sitting the same players two innings in a row. If a spot genuinely can’t be filled — for example everyone available has it set to Never, or every pitcher is at their cap — Auto-fill leaves that cell blank and shows a warning instead of forcing a bad fit, so you can adjust it by hand. Auto-fill always gives you a starting point you can edit before the game.',
          keywords: ['auto-fill', 'auto fill', 'generate lineup', 'fill lineup', 'never position', 'best position', 'ranked positions', 'position preferences', 'pitcher', 'ace', 'max innings', 'arm care', 'cant fill position', 'blank position', 'lineup warning', 'who plays where'],
          answer: (
            <>
              <p><strong>Auto-fill</strong> uses the positions you set on each player&apos;s profile. It <strong>never</strong> puts a player at a position you marked <strong>Never</strong>, and it favors each player&apos;s <strong>Best</strong> positions in the order you ranked them (<strong>Okay</strong> spots are used as fill-ins). For the <strong>mound</strong>, it uses your pitchers: competitive games lead with your <strong>ace</strong>, balanced and development games spread innings down the pitcher order, and it never works a pitcher past their <strong>max-innings cap</strong>. It still shares playing time fairly and avoids sitting the same players two innings in a row.</p>
              <p>If a spot genuinely can&apos;t be filled — for example everyone available has it set to <strong>Never</strong>, or every pitcher is at their cap — Auto-fill leaves that cell blank and shows a <strong>warning</strong> instead of forcing a bad fit, so you can set it by hand. Auto-fill always gives you a starting point you can edit before the game.</p>
            </>
          ),
        },
      ],
