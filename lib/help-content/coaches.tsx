    ...
    },
    {
      ...
      subtopics: [
        ...
        },
        {
          ...
          content: (
            <p>Staff and equipment are a pick-or-add list, the same idea as your practice tags: start typing and pick from what your team has used before, or press <strong>+ Add</strong> to put a new name or item on the list for good. A name or item only has to be typed correctly once — pick it again on the next block, station or practice instead of retyping it, and a near-duplicate spelling never splits into two entries. This applies wherever staff and equipment show up: the practice&rsquo;s own equipment line, each block&rsquo;s staff, and each station&rsquo;s who&rsquo;s-running-it and equipment. Fix a typo or fold two duplicates together and it updates everywhere that name or item was used — including nights you&rsquo;ve already run and printed.</p>
          ),
        },
        {
      ...
      faqs: [
        ...
        },
        {
          ...
          answerText: 'You can type it, but adding a genuinely new name or item takes one more press, on a clearly labelled "+ Add" button. That extra step is deliberate: it keeps two spellings of the same name or item, like "Coach Dana" and "coach dana", from quietly becoming two different entries on your list. Typing searches what your team has already used; if it matches, tap it. If it is genuinely new, press "+ Add" and it joins your list for good, ready to pick again on any block, station or practice. Fixing a typo or merging two duplicates later updates every practice that used it, including ones you have already run and printed.',
          keywords: ['add staff', 'add equipment', 'staff list', 'equipment list', 'why cant i add staff', 'press enter', 'new staff name', 'new equipment item', 'duplicate staff name', 'two spellings', 'who runs it list', 'kit list', 'rename staff', 'merge equipment'],
          answer: (
            <>
              <p>You can type it — but adding a genuinely <strong>new</strong> name or item takes one more press, on a clearly labelled <strong>+ Add</strong> button.</p>
              ...
              <p>Typing searches what your team has already used. If it matches, tap it. If it&rsquo;s genuinely new, press <strong>+ Add</strong> and it joins your list for good — ready to pick again on any block, station or practice. Fixing a typo or merging two duplicates later updates every practice that used it, including ones you&rsquo;ve already run and printed.</p>
            </>
          ),
        },
        {
