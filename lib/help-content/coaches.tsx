        ...
        },
        {
          ...
          content: (
            <>
              ...
              <p><strong>You can change it later, even after the club has answered.</strong> Every request row says what it is and what it files under — <em>New money · Grants · Association support</em> — with <strong>File it</strong> or <strong>Change</strong> beside it. That opens a small box holding only those two questions. <strong>Re-filing moves no money</strong>; it moves which row of the report tells the story. Requests that were approved before this question existed keep reading as repayments until you say otherwise — nothing was quietly re-interpreted behind you.</p>
              <p><strong>Every request is reviewed by someone at the club</strong>, and sits as <strong>Awaiting the club</strong> until the office gets to it — pinned to the top of the list, with a marked edge, because it is the only row you can still act on. Until then it&apos;s still yours: tap the row to correct anything — amount, wording, what it&apos;s for, even which direction it goes — or <strong>Withdraw request</strong> to take it off their list. Withdrawing asks first, because nothing is kept.</p>
        ...
        },
        {
          ...
          content: (
            <>
              ...
              <p>You don&rsquo;t have to come here for a quick fix — every <strong>Tags</strong> box across the portal carries <strong>Manage tags…</strong> as the last row of its dropdown, opening the same manager beside whatever you were doing. This shelf is the season-end tidy; each library holds up to 50 of your own tags, and merging two makes room.</p>
            </>
          ),
        },
        {
