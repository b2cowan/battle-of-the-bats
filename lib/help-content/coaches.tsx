      ...
      content: (
        <>
          ...
          <ul>
            ...
            <li><strong>Development</strong> — three reports behind one <strong>Report</strong> dropdown: <strong>Coverage</strong> (one row per player, roster order — <em>Current focus</em> or the metric you chose, with its own date, and who was named in a practice plan; a count line, never a ranking), <strong>Player progress</strong> (one player&rsquo;s one test on a dated chart, with the change stated in words and every attempt behind it), and <strong>Practice review</strong> (every planned practice labelled by what its records support).</li>
