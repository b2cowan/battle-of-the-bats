      ...
      content: (
        <>
          ...
          <ul>
            ...
            <li>A <strong>Development</strong> section on every player — plain-language focus areas with a simple status, and coach-logged <strong>measurables</strong> (like a 60-yd sprint time) with a trend line once a player has two readings.</li>
