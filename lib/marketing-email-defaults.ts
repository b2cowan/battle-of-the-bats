...
export const MARKETING_EMAIL_DEFAULTS: Record<string, MarketingEmailDefault> = {
  ...
  "spotlight_coaches_org": {
    ...
    description: "Sent Oct 1 to org owners. Pitches the Coaches Portal for the coaches on their teams.",
  ...
  "spotlight_coaches_coach": {
    ...
    description: "Sent Oct 1 to coach accounts. Pitches the standalone Coaches Portal.",
    subject: "For the coaches on your teams — a workspace that's actually theirs",
    heading: "For the coaches on your teams — a workspace that's actually theirs.",
