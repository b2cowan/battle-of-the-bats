...
- **Recommended packaging:** Use a hybrid model. Launch an org-level per-team Rep Team add-on first for Tournament Plus and League orgs, then pilot a standalone Team plan for unaffiliated coaches once the team-portability and billing architecture is deliberately designed.
