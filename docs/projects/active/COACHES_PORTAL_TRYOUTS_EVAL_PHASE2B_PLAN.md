...
### 2B.3 — Ranked decision board
- [ ] Candidates sorted by weighted composite; drag between **Offer / Waitlist / Not this season**; "roster spots remaining" counter; submitting calls the existing status workflow. (No coachability flag in the UI.)
