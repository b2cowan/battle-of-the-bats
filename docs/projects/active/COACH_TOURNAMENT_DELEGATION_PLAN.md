...
**Status:** BUILT on dev 2026-09-13 (owner "go ahead" the same day; chunks A + B in one pass; no migration); Owner QA **§181** owed; uncommitted at hand-off. Plan written 2026-09-13 from the code at dev `87b94167`.
