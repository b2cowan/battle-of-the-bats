...
**Branch:** `dev` (single shared branch). **Status:** ✅ **SHIPPED TO PROD 2026-06-15 (`3f20ed5b`)**, later extended beyond this plan's scope (layout v2→v3; up-next / needs-score / schedule-health panels added by follow-up commits). (Header previously said "Awaiting sign-off before build"; corrected + archived 2026-07-24 by the Codebase Cleanup audit, finding G30.)
