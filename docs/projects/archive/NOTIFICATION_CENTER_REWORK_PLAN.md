...
**Status:** ✅ **SHIPPED TO PROD 2026-07-06 (promote `58eec6f0`)** — the release history lists the Notification Centre rework in that promote. (Header previously said "unpushed… ready for owner browser test"; corrected + archived 2026-07-24 by the Codebase Cleanup audit, finding G08.) No migration.
