> STALE HEADER (corrected 2026-08-01): built 2026-07-30 + /simplify + /review + /docs complete — trust the PLAN doc, not the "planned, not started" line below. Owner QA tracked in active/OWNER_QA_LEDGER.md.

# PM Brief â€” Coach Portal Chunk I: The One Thing

**One line:** the team Overview stops shouting five things at once and says one â€” the single thing that
matters to *this* coach today â€” with their team's real numbers directly underneath it.
...
and to **close out the season**. Both cards were working as written â€” they just fire on the same situation,
...
Meanwhile the part of the page with actual information â€” dues owed, roster size, budget, tournaments â€”
...
right now. On a game day that's the game â€” opponent, arrival time, who's confirmed, whether the lineup is
set, and a Build lineup button. On a quiet week it's a question only the coach can answer â€” *"Your season
looks finished â€” 6â€“4, last game three weeks ago. Close it out?"* â€” with **"add the next event"** offered as
one of the answers, so nobody loses the door the old card was giving them. In the first week it's the next
setup step.

**Their team's numbers immediately underneath.** Six tiles â€” always the same six, in a slightly different
order depending on what's happening â€” sitting directly below the card instead of at the bottom of the page.
...
nudge â€” everything that isn't today's work â€” collapses into one calm list at the bottom.
...
## Role differences â€” this is the part to review closely
...
- **Lineups, schedule and attendance** are all-or-nothing grants â€” a coach either has the tool or doesn't
  see it at all â€” so "Build lineup" can never appear for someone who can't build one. On game day the
  button steps down gracefully: Build lineup â†’ Take attendance â†’ just the facts. The card never vanishes,
...
- **Closing a season** is a head coach's job. An assistant sees the same sentence with no button:
  *"your club closes the season â€” your Season Wrapped appears here when they do."* That's how it already
...
Budget tiles â€” so instead of a thinner page, those two slots fill with the questions they actually own:
**Attendance** (*87% season average Â· 3 players under 70%*) and **Playing time** (*fairly even across 10
games Â· 2 players well below*). Both come from data the portal already collects and already protects
...
- **The Season setup chip becomes the only home for onboarding.** The "New here? Take the 2-minute tour"
  offer stops sharing a bar with this season's next task â€” they were unrelated and read as one instruction.
...
**High** â€” this is a reported defect on the portal's landing page, and it is the first screen every premium
coach sees.

The work splits into four passes, and **the first one alone fixes the contradiction** and can ship on its
own:

1. The single card and the quiet tail â€” closes the reported bug.
...
Open a team's Overview as a head coach on four different teams â€” one with a game today, one with a game
later this week, one that's been quiet for three weeks, and one just starting out â€” and confirm you get
...
- Every action on the page can be completed by the coach being shown it â€” verified across six coach types.
...
2. Should head coaches also see the Attendance and Playing time tiles? That would mean a seventh tile.
   *(Recommended: no â€” they reach both from Insights, and money is the burden only they carry.)*
3. Confirm the season-record filters can live on the record page rather than the Overview.
   *(Recommended: yes â€” they're a setting, not a glanceable fact.)*
