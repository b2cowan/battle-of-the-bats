...
**ARCHIVED 2026-09-13 — complete.** Built, §179 ✅ 25/25, /review 6 fixes, committed `a274c83c`, all 2026-09-13; owner: "looks good, archive the project". Not yet on prod (code-only, no migration — rides the next promote). The hub artifact `2c569b73` keeps its URL; republish it by passing that URL, since the source file moved here.
