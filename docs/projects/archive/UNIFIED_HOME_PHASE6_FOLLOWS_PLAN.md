...
**Status:** ✅ **BUILT + SHIPPED TO PROD** — commit `2a2d2685` (2026-07-20); the 2026-07-22 prod promote (`c743c276`) lists "follow whole tournaments & organizations free-first" among shipped items. (Header previously said "BUILD NOT STARTED"; corrected + archived 2026-07-24 by the Codebase Cleanup audit, finding G04.) All six mockup decisions (F1–F6) owner-ratified 2026-07-20; artifact `d6a7c08b-9058-4533-9a2e-7cf989260848` **rev 3** was the binding visual spec. Free-first follow access is a logged business decision (BUSINESS_DECISIONS.md 2026-07-20).
