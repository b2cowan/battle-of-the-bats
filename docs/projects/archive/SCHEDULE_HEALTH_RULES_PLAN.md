...
> Status: **SHIPPED TO PROD — committed 2026-06-13 (`8564624c`), confirmed ancestor of origin/master.** (Header previously said "uncommitted — awaiting browser verification"; corrected 2026-07-24 by the Codebase Cleanup audit, finding G05 — the feature has been live for weeks with full wiring verified.) No migration (tournament `settings` JSONB). Archived 2026-07-24.
