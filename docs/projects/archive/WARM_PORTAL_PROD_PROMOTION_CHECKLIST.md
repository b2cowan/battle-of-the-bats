...
**Status:** ✅ **EXECUTED — the 2026-07-22 prod promote (`c743c276`) shipped exactly this bundle** (migs 193–196 applied to prod ahead of it; warm portal Stages 1–6 live). (Header previously said "NOT on prod"; corrected + archived 2026-07-24 by the Codebase Cleanup audit, finding G23.) Prepared 2026-07-22.
