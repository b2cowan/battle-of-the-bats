...
**Generated:** 2026-06-28 by `scripts/refresh-db-snapshots.mjs` (structure only — no business data).

**⚠️ 56 divergence(s)** across dev/prod.
...
## Columns
### Only in DEV (6)
- `rep_roster_players.bats`
- `rep_roster_players.emergency_contact_name`
- `rep_roster_players.emergency_contact_phone`
- `rep_roster_players.jersey_size`
- `rep_roster_players.medical_notes`
- `rep_roster_players.throws`
