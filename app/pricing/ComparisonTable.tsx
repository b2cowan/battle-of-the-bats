...
const COMPARISON_CATEGORIES = [
  ...
  },
  {
    ...
    rows: [
      ...
      { feature: 'Premium Coaches Portal — whole coaching staff', tournament: '—', plus: '—', league: '—', club: '✓ (every team included)' },
      { feature: 'Teams included',                            tournament: '—', plus: '—', league: '—', club: 'Up to 15 · up to 30 (Club · Association)' },
