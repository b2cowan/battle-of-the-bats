  ...
  return (
    <div className={styles.page}>
      ...
      <div style={{
        ...
        border: `1px solid ${hasNotifContact ? 'rgba(var(--logic-lime-rgb),0.25)' : 'rgba(var(--warning-rgb),0.35)'}`,
        borderRadius: '2px',
        background: hasNotifContact ? 'rgba(var(--logic-lime-rgb),0.04)' : 'rgba(var(--warning-rgb),0.06)',
        fontSize: '0.82rem',
        color: 'var(--white-60)',
        lineHeight: 1.5,
      }}>
