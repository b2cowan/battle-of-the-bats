...
- [ ] **No-Cost Automated Schedule Generator** — Schedule Health, dashboard summary, scored draft comparison, generate-another-set, priority presets/controls, facility-level selection, no-pool slot drafts, temporary Facility lane resolution, partial regeneration V1, durable manual game locks, and manual travel/setup buffers implemented; migrations 104-105 applied dev + prod; browser verified 2026-06-03; remaining optional pair-by-pair venue buffer refinement (see [plan](docs/projects/active/AUTOMATED_SCHEDULE_GENERATOR_PLAN.md) and [PM brief](docs/projects/active/AUTOMATED_SCHEDULE_GENERATOR_PM_BRIEF.md))
