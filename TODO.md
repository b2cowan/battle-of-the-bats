...
- [ ] **Role-Based UX Improvement Review** — Execute the UX Improvement Test Plan (`UX_IMPROVEMENT_TEST_PLAN.md`) to evaluate the platform from the perspective of all user roles (owner, admin, treasurer, coach, parent, etc.) and identify friction points for future polish.
