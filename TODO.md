...
- [ ] **Platform Improvements — Phase 2** — Member suspension state, officials overview page, seat meter on billing, 80% upgrade nudge, members page UX cleanup (see [PLATFORM_IMPROVEMENTS_PLAN.md](PLATFORM_IMPROVEMENTS_PLAN.md))
