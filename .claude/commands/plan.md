...
4. `memory/feedback_docs_folder_convention.md` — where plan files live (`docs/active/`)
...
- Create as `docs/active/[FEATURE_NAME]_PLAN.md`
...
- Format: `- [ ] **[Feature Name]** — [one-sentence description] (see docs/active/[FEATURE_NAME]_PLAN.md)`
...
- **Doc structure is strict** — plan files go in `docs/active/`; completed plans move to `docs/archive/`; nothing in repo root
...
When creating a new `docs/active/[NAME]_PLAN.md`:
...
- Create a plan file in the repo root (must be `docs/active/`)
