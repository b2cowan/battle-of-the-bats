...
1. `memory/project_ux_review.md` — 27 UX findings from the 2026-05-11 review; Phase 1 bugs are fixed; Phases 2–5 are open
2. `memory/design_principles.md` — UX conventions section (empty states, forms, tables, modals)
3. `docs/active/UX_REVIEW_PLAN.md` — full finding descriptions with file references (if it exists)
